...
export async function onRequest({ request }) {
  const body = {
    ...
    endpoint: "/api/laudo/salvar",
    description: "Persist\u00eancia de laudo m\u00e9dico",
    expected_payload: {"laudo_pdf": "base64", "patient_id": "string", "timestamp": "ISO"},
