/**
 * NeuroPed · /api/certificado/salvar
...
export async function onRequest({ request }) {
  const body = {
    ...
    endpoint: "/api/certificado/salvar",
    description: "Persist\u00eancia de certificado emitido",
    expected_payload: {"certificate_pdf": "base64", "patient_id": "string"},
