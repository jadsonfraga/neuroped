...
export function TabletLauncher({ locked }: { locked: boolean }) {
  ...
  return <>
    <section className="obs10-kind" data-testid="tablet-launcher">
      <div><h2>Aplicar somente com tablet e câmera</h2><p>Jornada em estações, como um percurso de videogame: Base → Radar → Tutorial → Checkpoint → atividades → Revisão → Saída. Sem papel, lápis ou brinquedos e sem pontos, ranking ou feedback de acerto/erro. Modo digital experimental, com cobertura diferente do presencial.</p><button ref={trigger} type="button" disabled={locked} onClick={() => {
