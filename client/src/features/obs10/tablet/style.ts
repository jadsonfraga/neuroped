...
.ot-world-track li[data-station-state=done] .ot-world-node,.ot-mission-map li[data-station-state=done] .ot-mission-node{background:hsl(var(--primary));border-color:hsl(var(--primary));color:hsl(var(--primary-foreground))}
