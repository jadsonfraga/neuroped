...
const schema = z.object({
  version: z.enum(["1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0"]),
...
export function parseRecordJSON(raw: string): ImportResult {
  ...
  try {
    ...
    if (!result.success) return { ok: false, error: "Arquivo incompatível ou incompleto. Aceitos registros OBS-10 1.0 a 1.6; nenhum dado atual foi alterado." };
