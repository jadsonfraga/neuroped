...
export default function EdiPage() {
  return (
    <GenericScale config={{
      ...
      labels: ediLabels,
      domains: ediDomains,
      infoBox: "EDINEXUS: 28 itens, domínio único, máximo 84 pontos. ATENÇÃO: itens sobre morte/desaparecer são marcadores de alarme — qualquer pontuação ≥ 2 nesses itens exige avaliação de risco imediata. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
