...
export default function EmdiPage() {
  return (
    <GenericScale config={{
      ...
      labels: emdiLabels,
      domains: emdiDomains,
      infoBox: "EMDINEXUS: 36 itens, 8 domínios, máximo 108 pontos. Pontuações mais altas indicam melhor desempenho funcional. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
