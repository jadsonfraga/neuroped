        ...
        <div className="space-y-5">
          ...
          <div className="grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
            ...
            <aside className="space-y-4">
              ...
              <label className="block text-sm font-bold">Registro presencial para copiar manualmente<textarea aria-label="Registro presencial para copiar manualmente" readOnly value={reportText} className="mt-2 min-h-64 w-full rounded-xl border bg-background p-3 text-sm font-normal" /></label>
