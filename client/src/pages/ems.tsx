...
export default function EmsPage() {
  return (
    <GenericScale config={{
      ...
      labels: emsLabels,
      domains: emsDomains,
      infoBox: "EMSNEXUS: 16 itens, domínio único, máximo 48 pontos. Pontuações mais altas indicam maior probabilidade de mutismo seletivo. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
