...
export default function EcsmPage() {
  return (
    <GenericScale config={{
      ...
      labels: ecsmLabels,
      domains: ecsmDomains,
      infoBox: "ECSM-J26: 15 itens, domínio único (Cognição Social), máximo 45 pontos. Pontuações mais altas indicam melhor cognição social. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
