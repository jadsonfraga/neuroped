...
const AGE_GROUPS: Record<AgeGroup, AgeGroupInfo> = {
  "6-7": {
    label: "6–7 anos",
    description: "1º–2º ano",
    color: "text-blue-600",
  },
  "8-9": {
    label: "8–9 anos",
    description: "3º–4º ano",
    color: "text-green-600",
  },
  "10-11": {
    label: "10–11 anos",
    description: "5º–6º ano",
    color: "text-purple-600",
  },
  "12-14": {
    label: "12–14 anos",
    description: "7º–9º ano",
...
const ITEMS: Record<AgeGroup, MathItem[]> = {
  "6-7": [
    ...
    },
    {
      ...
      options: ["4", "5", "6", "7"],
      correct: "6",
      explanation: "Subtração correta",
    },
    {
      id: "p1",
      type: "problema",
      question: "Maria tem 2 maçãs. Ganhou mais 3. Quantas tem agora?",
      options: ["3", "4", "5", "6"],
      correct: "5",
      explanation: "Problema simples de adição",
    },
    {
      id: "p2",
      type: "problema",
      question: "João comeu 2 de 5 biscoitos. Quantos restam?",
      options: ["2", "3", "4", "5"],
      correct: "3",
      explanation: "Problema de subtração",
    },
    {
      id: "s1",
      type: "sequencia",
      question: "2, 4, 6, ? → Qual número segue?",
      options: ["7", "8", "9", "10"],
      correct: "8",
      explanation: "Sequência de pares",
    },
  ],
  "8-9": [
    {
      ...
      options: ["40", "42", "43", "45"],
      correct: "43",
      explanation: "Adição com dezenas",
    },
    {
      id: "c2",
      type: "calculo",
      ...
      options: ["25", "27", "30", "35"],
      correct: "27",
      explanation: "Subtração com dezenas",
    },
    {
      id: "c3",
      type: "calculo",
      ...
      options: ["20", "24", "28", "30"],
      correct: "24",
      explanation: "Multiplicação simples",
    },
    {
      id: "p1",
      type: "problema",
      question: "Uma caixa tem 12 lápis. Há 3 caixas. Quantos lápis no total?",
      options: ["30", "35", "36", "40"],
      correct: "36",
      explanation: "Problema de multiplicação",
    },
    {
      id: "s1",
      type: "sequencia",
      question: "3, 6, 12, ? → Qual número segue?",
      options: ["20", "24", "30", "36"],
      correct: "24",
      explanation: "Sequência: dobra cada número",
    },
  ],
  "10-11": [
    {
      ...
      correct: "212",
      explanation: "Adição com centenas",
    },
    {
      id: "c2",
      type: "calculo",
      ...
      options: ["45", "55", "60", "65"],
      correct: "55",
      explanation: "Subtração com centenas",
    },
    {
      id: "c3",
      type: "calculo",
    ...
    },
    {
      ...
      type: "problema",
      question:
        "Uma loja vende 15 livros por dia. Em uma semana (7 dias), quantos vende?",
      options: ["100", "105", "110", "120"],
      correct: "105",
      explanation: "Problema com multiplicação",
    },
    {
      id: "s1",
      type: "sequencia",
      question: "5, 10, 20, 40, ? → Qual número segue?",
  ...
  "12-14": [
    {
      ...
      type: "calculo",
      question: "456 + 789 = ?",
      options: ["1200", "1245", "1245", "1300"],
      correct: "1245",
      explanation: "Adição com números grandes",
    },
    {
      id: "c2",
      type: "calculo",
      question: "1000 - 342 = ?",
      options: ["658", "668", "678", "700"],
      correct: "658",
      explanation: "Subtração com números grandes",
    },
    {
      id: "c3",
      type: "calculo",
      ...
      correct: "400",
      explanation: "Multiplicação com dezenas",
    },
    {
      id: "c4",
      type: "calculo",
    ...
    },
    {
      ...
      type: "problema",
      question:
        "Um ônibus tem 45 passageiros. Sobem mais 28. Descem 15. Quantos ficam?",
      options: ["45", "55", "58", "65"],
      correct: "58",
      explanation: "Problema com múltiplas operações",
    },
    {
      id: "s1",
      type: "sequencia",
      question: "1, 4, 9, 16, 25, ? → Qual número segue?",
      options: ["30", "35", "36", "40"],
      correct: "36",
      explanation: "Sequência: quadrados perfeitos (1², 2², 3², 4², 5², 6²)",
    },
  ],
};
  ...
  if (showReport) {
    ...
    return (
      <div className="space-y-4">
        <ClinicalReport
          scaleName="Acadêmico Interativo"
          scaleFullName="Cálculos, problemas matemáticos e sequências lógicas"
          items={reportItems}
          patientAge={AGE_GROUPS[selectedAge].label}
        />
        <SaveToPatient
          testName="Acadêmico Interativo"
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600">
            Cálculos, problemas matemáticos e sequências lógicas.
          </p>
        </CardContent>
      </Card>
