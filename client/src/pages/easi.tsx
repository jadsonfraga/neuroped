...
export default function EasiPage() {
  return (
    <GenericScale config={{
      ...
      labels: easiLabels,
      domains: easiDomains,
      infoBox: "EASI-J26: 15 itens, domínio único, máximo 45 pontos. Pontuações mais altas indicam maior ansiedade social. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
