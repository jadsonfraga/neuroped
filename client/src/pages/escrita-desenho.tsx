...
const TASKS: Record<AgeGroup, Task[]> = {
  "3-4": [
    {
      ...
      rubric: {
        0: "Não tenta ou rabisco",
        1: "Tenta mas com dificuldade",
        2: "Desenha círculo reconhecível",
      },
    },
    {
      id: "d2",
      ...
      rubric: {
        0: "Rabisco sem forma",
        1: "Tenta alguns elementos",
        2: "Casa reconhecível com 3+ elementos",
      },
    },
    {
      id: "d3",
      ...
      rubric: {
        0: "Não reconhecível",
        1: "Alguns membros faltando",
        2: "Pessoa com 4+ partes",
      },
    },
    {
      id: "c1",
      ...
      rubric: {
        0: "Não copia",
        1: "Tenta mas desorganizado",
        2: "Linha clara e direita",
      },
    },
  ],
  "5-6": [
    ...
    },
    {
      ...
      rubric: {
        0: "Ilegível ou recusa",
        1: "Parcialmente legível",
        2: "Nome claro e legível",
      },
    },
    {
      id: "d1",
  ...
  "8-9": [
    ...
    },
    {
      ...
      rubric: {
        0: "Muito difícil de ler",
        1: "Legível com esforço",
        2: "Claro e organizado",
      },
    },
    {
      id: "d1",
      ...
      rubric: {
        0: "Rabisco sem sentido",
        1: "Alguns elementos",
        2: "Cena clara com 3+ elementos",
      },
    },
  ],
  "10-11": [
    {
      ...
      rubric: {
        0: "Incoerente ou ilegível",
        1: "Legível mas com erros",
        2: "Claro, coerente e bem organizado",
      },
    },
    {
      id: "c1",
      ...
      rubric: {
        0: "Muitos erros",
        1: "Alguns erros pequenos",
        2: "Cópia fiel e legível",
      },
    },
    {
      id: "d1",
      type: "desenho",
      instruction:
        "Desenhe um autorretrato (seu rosto) com detalhes (olhos, nariz, boca, cabelo, orelhas)",
      criteria: ["Simetria básica", "6+ detalhes", "Proporção facial"],
      rubric: {
        0: "Muito simples ou não reconhecível",
        1: "Básico com alguns detalhes",
        2: "Autorretrato com detalhes e proporção",
      },
    },
  ],
};
  ...
  if (showReport) {
    ...
    return (
      <div className="space-y-4">
        <ClinicalReport
          scaleName="Escrita e Desenho"
          scaleFullName="Tarefas de desenho, cópia e escrita"
          items={reportItems}
          patientAge={AGE_GROUPS[selectedAge].label}
        />
        <SaveToPatient
          testName="Escrita e Desenho"
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>
              Tarefa {currentTaskIdx + 1}/{tasks.length}
            </CardTitle>
            <Badge>
              {answered}/{tasks.length} respondidas
            </Badge>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <p className="text-xs text-gray-700">
              Critérios: {currentTask.criteria.join(", ")}
            </p>
          </div>
          ...
          {currentTask.type === "desenho" && (
            <div className="space-y-2">
              <p className="text-xs font-semibold">
                Desenho — Use o mouse/toque para desenhar:
              </p>
              <canvas
                ref={canvasRef}
                width={500}
          ...
          {(currentTask.type === "copia" || currentTask.type === "escrita") && (
            <div className="space-y-2">
              <p className="text-xs font-semibold">
                {currentTask.type === "copia"
                  ? "✍️ Cópia — Criança escreve aqui:"
                  : "✍️ Escrita — Criança escreve aqui:"}
              </p>
              <textarea
              ...
              {[
                ...
                <div key={option.score} className="flex items-center space-x-2">
                  <Button
                    size="sm"
                    variant={
                      scores[currentTask.id] === option.score
                        ? "default"
                        : "outline"
                    }
          ...
          <div className="text-xs text-gray-600 bg-gray-50 p-2 rounded">
            <p>
              <strong>Explicação da pontuação:</strong>
            </p>
