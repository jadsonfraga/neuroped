  ...
  "2-3": [
    {
      ...
      rubric: {
        0: "Cai ou não consegue",
        1: "Tenta mas oscila",
        2: "Anda com equilíbrio claro",
      },
    },
    {
      id: "g2",
    ...
    },
    {
      ...
      rubric: {
        0: "Preensão inadequada",
        1: "Preensão parcial",
        2: "Trípode ou cilindro adequado",
      },
    },
  ],
  "4-5": [
    {
      ...
      rubric: {
        0: "Cai ou não consegue",
        1: "Tenta mas desequilibra",
        2: "Pula com equilíbrio claro",
      },
    },
    {
      id: "g2",
      ...
      rubric: {
        0: "Não consegue",
        1: "Chuta mas sem controle",
        2: "Chuta com força e direção",
      },
    },
    {
      id: "f1",
      ...
      rubric: {
        0: "Não consegue usar tesoura",
        1: "Abre/fecha mas sem controle",
        2: "Corta linha reta",
      },
    },
    {
      ...
      rubric: {
        0: "Não consegue",
        1: "Com ajuda de adulto",
        2: "Sozinho com facilidade",
      },
    },
  ],
  "6-7": [
    {
      ...
      rubric: {
        0: "Cai antes de 3 segundos",
        1: "Mantém 5-10 segundos",
        2: "Mantém 10+ segundos com estabilidade",
      },
    },
    {
      id: "g2",
      ...
      rubric: {
        0: "Corre mas sem controle",
        1: "Consegue mudar com dificuldade",
        2: "Ágil e coordenado",
      },
    },
    {
    ...
    },
    {
      ...
      rubric: {
        0: "Simples ou desorganizado",
        1: "Alguns detalhes",
        2: "Proporção e detalhe adequados",
      },
    },
  ],
  "8-9": [
    ...
    },
    {
      ...
      rubric: {
        0: "Muito lento ou muitos erros",
        1: "Razoável com alguns erros",
        2: "Rápido e preciso",
      },
    },
    {
  ...
  if (showReport) {
    ...
    return (
      <div className="space-y-4">
        <ClinicalReport
          scaleName="Motricidade"
          scaleFullName="Tarefas de coordenação motora grossa e fina"
          items={reportItems}
          patientAge={AGE_GROUPS[selectedAge].label}
        />
        <SaveToPatient
          testName="Motricidade"
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600">
            Avaliação de coordenação motora grossa (equilíbrio, locomoção) e
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          {tasks.map((task, idx) => (
            <div
              key={task.id}
              className="border-l-4 border-green-300 pl-4 py-2"
            >
              <div className="mb-3">
