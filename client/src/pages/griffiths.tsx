...
// Substitua: "griffiths", "Griffiths III", "Griffiths III", etc.
...
const SCALE_CONFIG = {
  id: ""griffiths"", // ex: "bayley"
  name: ""Griffiths III"", // ex: "Bayley-III"
  fullName: ""Griffiths III"", // ex: "Bayley Scales of Infant Development III"
  whenToUse: [
    "✅ Indicação 1",
    "✅ Indicação 2",
    "✅ Indicação 3",
