...
export default function HomePage() {
  ...
  const ferramentasCards: ScaleCard[] = [
    ...
    { href: "/filtro", title: "Filtro Clínico Inteligente", subtitle: "Escalas por idade e queixa", description: "Informe idade e queixa para priorizar instrumentos clínicos adequados.", icon: Filter, ageRange: "Clínico", gradient: "from-primary to-chart-2", bgLight: "bg-primary/5 dark:bg-primary/10", iconColor: "text-primary" },
