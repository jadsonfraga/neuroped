        ...
        <div className="relative flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <Badge className="mb-2 rounded-full bg-violet-100 text-violet-700 dark:bg-violet-950 dark:text-violet-300 hover:bg-violet-100">
              triagem pedagógica · 2–19 anos
            </Badge>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">
              Mapa de aprendizagem escolar
            </h1>
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
              Uma amostra curta de conhecimentos escolares por faixa etária e
              escolarização: reconhecimento visual, leitura, escrita e
              aritmética. O resultado descreve habilidades observadas e pontos
              para conversar na consulta — não produz QI, percentil ou
              diagnóstico.
            </p>
          </div>
        </div>
      ...
      {confirmed && band && assessmentFinished && (
        ...
        >
          ...
          {completedDomains.length > 0 && (
            <div className="space-y-4">
              <ClinicalReport
                scaleName="Mapa de aprendizagem escolar"
                scaleFullName="Amostra pedagógica de reconhecimento visual, leitura, escrita e aritmética"
                items={reportItems}
