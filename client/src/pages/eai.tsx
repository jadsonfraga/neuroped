...
export default function EaiPage() {
  return (
    <GenericScale config={{
      ...
      labels: eaiLabels,
      domains: eaiDomains,
      infoBox: "EAINEXUS: 21 itens, domínio único, máximo 63 pontos. Pontuações mais altas indicam maior sintomatologia ansiosa. Instrumento autoral — Dr. Jadson Fraga, 2026.",
      onCalculate: (answers) => {
