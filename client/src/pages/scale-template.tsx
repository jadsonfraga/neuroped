...
// Substitua: SCALE_ID, SCALE_NAME, SCALE_FULL_NAME, etc.
...
const SCALE_CONFIG = {
  id: "SCALE_ID", // ex: "bayley"
  name: "SCALE_NAME", // ex: "Bayley-III"
  fullName: "SCALE_FULL_NAME", // ex: "Bayley Scales of Infant Development III"
  whenToUse: [
    "✅ Indicação 1",
    "✅ Indicação 2",
    "✅ Indicação 3",
