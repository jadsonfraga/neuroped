    ...
    >
      ...
      >
        <DialogHeader className="border-b border-card-border px-4 py-4 pr-12 text-left">
          <DialogTitle>{passwordChangeRequired ? "Troca de senha obrigatória" : "Preferências"}</DialogTitle>
          <DialogDescription>
            {passwordChangeRequired
        ...
        {remoteAccount && (
          ...
          >
            ...
            {passwordError && (
              <p className="rounded-lg border border-destructive/30 bg-destructive/10 p-2 text-xs text-destructive" role="alert">
                {passwordError}
              </p>
            )}
            <Button
        ...
        <div className="border-t border-card-border p-3">
          <p className="text-[10px] leading-relaxed text-muted-foreground">
            Preferências visuais ficam neste dispositivo. Senhas nunca são persistidas pelo NeuroPed.
          </p>
        </div>
      </DialogContent>
    </Dialog>
