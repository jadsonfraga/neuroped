    ...
    <div className="np-app-shell flex min-h-screen bg-background">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, hsl(var(--primary)/0.06) 0%, transparent 80%)",
          }}
        >
              ...
              <div key={sectionKey || si} className="space-y-1">
                {section.title && !collapsed && (
                  <button
                    ...
                    className="group flex w-full items-center gap-2 rounded-md px-3 pt-3.5 pb-1.5 text-left text-[10px] font-bold uppercase tracking-[0.14em] text-muted-foreground/80 hover:text-primary/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors duration-150"
                    aria-expanded={sectionOpen}
                    aria-controls={`nav-section-${si}`}
                  >
                    <span className="flex-1 truncate">{section.title}</span>
                    <ChevronDown
                      className={`h-3 w-3 opacity-60 group-hover:opacity-100 transition-all ${sectionOpen ? "rotate-180" : ""}`}
                      style={{
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              className={`relative flex items-center gap-3 px-3 py-2.5 min-h-[44px] rounded-lg cursor-pointer border transition-all duration-200 overflow-hidden ${
                                golden
                                  ? active
                                  ...
                                  : connection
                                    ...
                                    : priority
                                      ...
                                      : active
                                        ? "border-transparent bg-[linear-gradient(90deg,hsl(var(--primary)/0.14),hsl(var(--primary)/0.05),transparent)] text-primary font-semibold"
                                        : "border-transparent text-sidebar-foreground hover:bg-sidebar-accent/70 hover:text-foreground"
                              } ${collapsed ? "lg:justify-center" : ""}`}
                            >
                              {/* Premium active left-bar indicator */}
                              {active && !golden && !connection && !priority && (
                                <motion.span
                              ...
                              <item.icon
                                className={`w-[17px] h-[17px] flex-shrink-0 transition-transform ${
                                  golden
                              ...
                              />
                              {!collapsed && (
                                <span className="text-[12.5px] truncate leading-snug">
                                  {item.label}
                                </span>
                              )}
                              {collapsed && (
                              ...
                              {active && !collapsed && !golden && (
                                <motion.div
                                  layoutId="nav-active-dot"
                                  className="ml-auto w-1.5 h-1.5 rounded-full bg-primary/70"
                                  transition={{
                                    duration: 0.2,
                                    ease: easing.smooth,
                                  }}
      ...
      <main
        ...
        className={`np-app-main flex-1 min-w-0 transition-all duration-300 pt-14 lg:pt-0 print:!ml-0 print:!pt-0 ${collapsed ? "lg:ml-16" : "lg:ml-[280px]"}`}
      >
        {showClinicalFlow && (
