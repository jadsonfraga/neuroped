...
export const PUBLIC_ROUTES = [
  ...
  "/verificar-email", // Consome o token de confirmação de posse do e-mail
  "/planos", // Página comercial pública: o que é, para quem, preço e CTA — sem dado clínico
  ...
  "/especialidades", // Vitrine institucional premium de especialidades — sem dado clínico
