...
export const escalasAutoraisDrive2026Lote5: ScaleEntry[] = [
  {
    id: "vigia-med-24",
    name: "VIGIA-MED 24",
    fullName: "VIGIA-MED 24 — Mapa Autoral de Tolerabilidade e Segurança Medicamentosa",
    ageMin: 36,
    ageMax: 215,
  ...
  },
  {
    id: "nexo-fam-24",
    name: "NEXO-FAM 24",
    fullName: "NEXO-FAM 24 — Mapa Clínico Autoral de Sustentabilidade Familiar do Cuidado",
    ageMin: 0,
    ageMax: 215,
