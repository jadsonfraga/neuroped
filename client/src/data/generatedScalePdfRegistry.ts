...
export const generatedScalePdfRegistry: GeneratedScalePdfManifest[] = [
  ...
  },
  {
    ...
    totalOperationalItems: 200,
    modules: [
      { id: "ipn-epi-seg-familia-50", expectedItems: 50, ageMin: 0, ageMax: 215, respondent: "pais" },
      ...
      { id: "ipn-epi-seg-anamnese-20", expectedItems: 20, ageMin: 0, ageMax: 215, respondent: "clinico" },
      { id: "ipn-epi-seg-diferenciais-20", expectedItems: 20, ageMin: 0, ageMax: 215, respondent: "clinico" },
      { id: "ipn-epi-seg-seguranca-20", expectedItems: 20, ageMin: 0, ageMax: 215, respondent: "clinico" },
