...
export const supplementalFilterableInstruments: ScaleEntry[] = [
  ...
  // Aparecem no filtro ao selecionar o respondente "Direto" (teste_direto_crianca).
  {
    ...
    tempo: "10–15 min", appRoute: "/academico-interativo", description: "Teste direto e interativo de matemática (cálculo, problemas, sequências) por faixa etária.", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10 min", appRoute: "/conhecimentos-gerais", description: "Teste direto interativo de conhecimentos gerais, raciocínio e cultura.", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10 min", appRoute: "/conhecimento-visual", description: "Teste direto interativo de habilidades visuais (discriminação, figura-fundo, simetria, sequências).", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10–15 min", appRoute: "/escrita-desenho", description: "Teste direto interativo de escrita e desenho (traçado, cópia de formas).", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10–15 min", appRoute: "/motricidade-teste", description: "Teste direto de motricidade grossa e fina, por faixa etária.", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10–15 min", appRoute: "/funcoes-executivas", description: "Teste direto interativo de funções executivas (planejamento, inibição, memória de trabalho, flexibilidade).", licencaUso: "autoral",
  },
  {
    id: "atencao-concentracao", name: "Atenção e Concentração", fullName: "Atenção sustentada, seletiva e dividida (interativo)",
    ageMin: 72, ageMax: 168, queixas: ["tdah", "cognicao"], respondente: ["teste_direto_crianca"],
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10 min", appRoute: "/atencao-concentracao", description: "Teste direto interativo de atenção (sustentada, seletiva, dividida).", licencaUso: "autoral",
  },
  {
    ...
    tempo: "10–15 min", appRoute: "/linguagem-fonologia", description: "Teste direto interativo de linguagem e fonologia (consciência fonológica, vocabulário, compreensão, expressão).", licencaUso: "autoral",
  },
  {
    ...
    prioridade: "triagem", applicationMode: "teste_direto_crianca", assessmentUse: "triagem", implementationStatus: "complete",
    tempo: "10–15 min", appRoute: "/memoria-teste", description: "Teste direto interativo de memória (curto prazo, trabalho, episódica, aprendizagem verbal).", licencaUso: "autoral",
  },
  {
