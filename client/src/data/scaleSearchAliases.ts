...
export const searchSynonymGroups: Readonly<Record<string, readonly string[]>> = {
  tea: ["autismo", "autista", "autismo infantil", "espectro autista", "espectro", "asd", "autism", "tea leve", "suspeita de autismo", "nao olha nos olhos", "nao aponta", "nao responde ao nome", "se isola", "ecolalia", "alinha brinquedos", "estereotipia", "flapping", "alinha os brinquedos", "bate as maos", "balanca as maos", "gira objetos", "roda objetos", "nao brinca com outras criancas", "pouco olho no olho", "nao atende quando chama", "prefere ficar sozinho", "preso a rotina", "repete falas"],
  tdah: ["adhd", "deficit de atencao", "hiperatividade", "hiperativo", "hiperativa", "desatencao", "desatento", "desatenta", "impulsividade", "impulsivo", "nao para quieto", "agitado", "agitada", "agitacao", "distraido", "distraida", "nao presta atencao", "dda", "tda", "muito agitado", "muito agitada", "nao consegue ficar sentado", "nao consegue ficar sentada", "esquece tudo", "perde as coisas", "nao termina o que comeca", "fala demais", "nao espera a vez", "dificuldade de focar", "nao se concentra", "nao consegue se concentrar", "desconcentrado", "desconcentrada"],
  ansiedade: ["ansioso", "ansiosa", "medo", "medos", "fobia", "panico", "preocupacao", "preocupado", "nervoso", "nervosa", "anxiety", "ansiedade de separacao", "timidez", "dor de barriga", "medo de ficar longe", "nao quer ir para a escola", "nao quer ir pra escola", "roi as unhas", "roe as unhas", "vergonha de falar", "muito preocupado", "muito preocupada"],
  depressao: ["deprimido", "deprimida", "depressivo", "tristeza", "triste", "humor", "desanimo", "desanimado", "apatia", "choro facil", "depression", "mood", "chora facil", "chora a toa", "sem vontade de nada", "nao quer brincar", "se acha feio", "se acha feia", "sem energia", "isolado no quarto"],
  suicidio: ["suicida", "ideacao suicida", "autolesao", "automutilacao", "se corta", "se machuca", "risco de suicidio", "suicide", "self harm", "quer morrer", "fala em morrer", "falou em morrer", "quer sumir", "nao quer mais viver", "se machucar de proposito", "ideia de morte"],
  psicose: ["psicotico", "alucinacao", "alucinacoes", "delirio", "mania", "bipolar", "bipolaridade", "psychosis", "ouve vozes"],
  comportamento: ["agressividade", "agressivo", "agressiva", "birra", "birras", "oposicao", "opositor", "desafiador", "desafiadora", "tod", "conduta", "bate", "morde", "explosivo", "irritabilidade", "irritado", "irritada", "desregulacao", "externalizante", "behavior", "desafia", "desafiante", "nao obedece", "responde mal", "crises de raiva", "ataques de raiva", "quebra as coisas", "briga na escola", "mente muito", "faz birra"],
  linguagem: ["fala", "nao fala", "fala pouco", "atraso de fala", "atraso na fala", "comunicacao", "vocabulario", "fonologia", "gagueira", "troca letras", "fala enrolado", "tdl", "language", "speech", "gagueja", "troca letras", "troca as letras", "fala poucas palavras", "ninguem entende o que fala", "fala enrolada", "so a mae entende"],
  atraso: ["desenvolvimento", "atraso global", "marcos", "marco", "nao anda", "nao senta", "demora para andar", "bebe", "lactente", "prematuro", "prematuridade", "delay", "milestones", "ainda nao anda", "ainda nao senta", "ainda nao fala", "demora pra sentar", "demora pra andar", "demora pra falar", "nao engatinha", "nao engatinhou", "corpo mole", "molinho", "perdeu habilidade", "perdeu algo que ja fazia", "atras das criancas da idade"],
  aprendizagem: ["escola", "escolar", "leitura", "escrita", "dislexia", "discalculia", "disgrafia", "matematica", "nota baixa", "repetiu de ano", "dificuldade escolar", "academico", "learning", "nao aprende", "dificuldade para aprender", "nao consegue ler", "nao consegue escrever", "reprovou", "nota baixa", "dificuldade na escola", "problemas na escola"],
  sono: ["dormir", "dorme mal", "nao dorme", "insonia", "ronco", "despertares", "acorda a noite", "pesadelo", "sonolencia", "apneia", "sleep", "melatonina", "pesadelos", "ronca", "acorda cansado", "acorda cansada", "demora para dormir", "demora pra dormir", "acorda varias vezes", "range os dentes", "terror noturno", "sonambulo", "dorme na aula"],
  epilepsia: ["crise", "crises", "convulsao", "convulsoes", "epileptico", "epileptica", "ausencia", "desmaio", "seizure", "eeg", "desmaia", "fica parado olhando", "olhar parado", "revira os olhos", "treme e perde a consciencia", "perde a consciencia", "crise convulsiva"],
  pc: ["paralisia cerebral", "paralisia", "espasticidade", "espastico", "hemiparesia", "diparesia", "tetraparesia", "cerebral palsy"],
  motor: ["motricidade", "coordenacao", "desajeitado", "desajeitada", "cai muito", "motor fino", "motor grosso", "dispraxia", "apraxia", "hipotonia", "tonus", "marcha", "equilibrio", "cai muito", "tropeca muito", "nao consegue pular", "letra feia", "nao segura o lapis", "dificuldade de amarrar", "corre esquisito"],
  sensorial: ["hipersensibilidade", "sensibilidade", "barulho", "textura", "texturas", "integracao sensorial", "processamento sensorial", "seletivo com roupa", "sensory", "etiqueta", "etiqueta da roupa", "nao gosta de barulho", "tapa os ouvidos", "nao gosta de abraco", "cheira tudo", "coloca tudo na boca", "anda na ponta dos pes"],
  alimentacao: ["seletividade alimentar", "seletivo", "seletiva", "nao come", "recusa alimentar", "engasgo", "engasga", "disfagia", "arfid", "tare", "anorexia", "bulimia", "compulsao alimentar", "eating", "so come", "come pouco", "come poucos alimentos", "recusa comida", "vomita", "muito magro", "muito magra", "come demais", "nao mastiga", "so come pastoso"],
  dor: ["cefaleia", "dor de cabeca", "enxaqueca", "migranea", "dor cronica", "pain", "headache", "dor de cabeca forte", "dor de cabeca frequente", "dor nas pernas", "dor cronica", "dor toda semana"],
  cognicao: ["inteligencia", "qi", "deficiencia intelectual", "di", "raciocinio", "memoria", "funcao executiva", "funcoes executivas", "neuropsicologico", "cognitivo", "cognitiva", "demora para entender", "nao entende o que le", "esquece o que aprende", "raciocinio lento"],
  ...
  autonomia: ["autocuidado", "vida diaria", "avd", "avds", "independencia", "se veste sozinho", "desfralde", "nao se veste sozinho", "nao se veste sozinha", "nao come sozinho", "nao come sozinha", "depende de tudo", "nao tira a fralda", "ainda usa fralda"],
  neonatal: ["recem nascido", "rn", "neonato", "uti neonatal", "prematuro extremo"],
  tiques: ["tique", "tic", "tics", "tourette", "piscar", "cacoete", "cacoetes", "pisca", "pisca muito", "caretas", "faz caretas", "funga", "pigarreia", "movimentos repetidos do rosto", "sons repetidos"],
  toc: ["obsessao", "obsessoes", "compulsao", "compulsoes", "ritual", "rituais", "mania de limpeza", "ocd", "obsessivo", "lava as maos", "lava as maos toda hora", "checa varias vezes", "confere varias vezes", "mania de organizar", "medo de contaminacao", "pensamentos ruins repetidos"],
  trauma: ["tept", "ptsd", "estresse pos traumatico", "abuso", "violencia", "luto", "evento traumatico", "abuso", "sofreu abuso", "viu violencia", "acidente grave", "morte na familia", "pesadelos com o ocorrido", "susto forte"],
  enurese: ["xixi na cama", "faz xixi na cama", "escape urinario", "encoprese", "coco na roupa", "incontinencia", "bexiga", "molha a cama", "faz coco na roupa", "segura o xixi", "prende o coco", "escape de fezes", "faz xixi na roupa"],
  efeitos: ["medicacao", "medicamento", "remedio", "efeito colateral", "efeitos colaterais", "efeitos adversos", "tolerabilidade", "adesao", "ritalina", "metilfenidato", "risperidona", "aripiprazol", "satisfacao", "ficou sem apetite com o remedio", "remedio deixou agitado", "efeito da medicacao", "reacao ao remedio", "perdeu apetite", "sonolento com o remedio"],
  ...
  social: ["habilidades sociais", "amizade", "amigos", "sem amigos", "bullying", "reciprocidade", "pragmatica", "isolamento social", "mutismo seletivo", "nao fala na escola", "sem amigos", "nao tem amigos", "nao faz amigos", "fica sozinho no recreio", "sofre bullying", "nao fala com estranhos"],
  substancias: ["drogas", "alcool", "maconha", "uso de substancias", "vape", "cigarro", "bebe escondido", "cheiro de maconha", "usa drogas", "fuma"],
