...
const PDF_SHA256 = [
  "326e2186e04cbdc36cc8b094c3d41fa4",
  "97dd75133c2a3b95c21a36f2a09837c6",
].join("");
...
export const ipnEpiSegModules: IpnEpiSegModuleContract[] = [
  {
    key: "familia", id: "ipn-epi-seg-familia-50", label: "Família e Cuidadores", expectedItems: 50,
    ageMin: 0, ageMax: 215, informants: ["pais"], assessmentUse: "triagem",
    communication: "indiferente", literacy: "indiferente",
    contextTags: ["casa", "sono", "banho", "alimentação", "medicação", "transporte", "segurança"],
    implementationStatus: "complete", scored: true, redFlagsOutsideScore: false,
  },
  {
    key: "escola", id: "ipn-epi-seg-escola-30", label: "Escola e Equipe Terapêutica", expectedItems: 30,
    ageMin: 24, ageMax: 215, informants: ["professor"], assessmentUse: "triagem",
    communication: "indiferente", literacy: "indiferente",
    contextTags: ["escola", "AEE", "transporte escolar", "educação física", "recreio", "excursão"],
    implementationStatus: "complete", scored: true, redFlagsOutsideScore: false,
  },
  {
    key: "autopercepcao", id: "ipn-epi-seg-autopercepcao-20", label: "Autopercepção Apoiada", expectedItems: 20,
    ageMin: 96, ageMax: 215, informants: ["autoaplicavel"], assessmentUse: "triagem",
    communication: "nao_verbal_compativel", literacy: "indiferente",
    contextTags: ["casa", "escola", "amizades", "sono", "atividade física", "privacidade"],
    implementationStatus: "complete", scored: true, redFlagsOutsideScore: false,
  },
  {
    key: "observacao", id: "ipn-epi-seg-observacao-20", label: "Observação Clínica", expectedItems: 20,
    ageMin: 0, ageMax: 215, informants: ["clinico"], assessmentUse: "triagem",
    communication: "indiferente", literacy: "indiferente",
    contextTags: ["consulta", "vídeo", "exame", "pós-evento", "estado interictal"],
    implementationStatus: "complete", scored: true, redFlagsOutsideScore: false,
  },
  {
    key: "anamnese", id: "ipn-epi-seg-anamnese-20", label: "Anamnese", expectedItems: 20,
    ageMin: 0, ageMax: 215, informants: ["clinico"], assessmentUse: "diagnostico",
    communication: "indiferente", literacy: "indiferente",
  ...
  {
    key: "diferenciais", id: "ipn-epi-seg-diferenciais-20", label: "Diferenciais", expectedItems: 20,
    ageMin: 0, ageMax: 215, informants: ["clinico"], assessmentUse: "diagnostico",
    communication: "indiferente", literacy: "indiferente",
  ...
  {
    key: "seguranca", id: "ipn-epi-seg-seguranca-20", label: "Segurança e Red Flags", expectedItems: 20,
    ageMin: 0, ageMax: 215, informants: ["pais", "professor", "autoaplicavel", "clinico"], assessmentUse: "triagem",
    communication: "indiferente", literacy: "indiferente",
    contextTags: ["urgência", "casa", "escola", "água", "altura", "trânsito", "medicação"],
    implementationStatus: "complete", scored: false, redFlagsOutsideScore: true,
  },
  {
    key: "sintese", id: "ipn-epi-seg-sintese-20", label: "Síntese e Plano", expectedItems: 20,
    ageMin: 0, ageMax: 215, informants: ["clinico"], assessmentUse: "monitorizacao",
    communication: "indiferente", literacy: "indiferente",
