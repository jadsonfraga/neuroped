...
export const firstLineByQueixa: Record<string, string[]> = {
  ...
  depressao: ["/phqa", "/generic-scale/rcads", "/cssrs", "/sdq"],
  suicidio: ["/cssrs", "/phqa"],
...
export const firstLineByCrossed: Record<string, string[]> = {
  ...
  "ansiedade+depressao": ["/scared", "/generic-scale/rcads", "/phqa", "/cssrs"],
  "depressao+suicidio": ["/cssrs", "/phqa", "/generic-scale/rcads"],
