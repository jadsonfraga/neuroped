...
export const sdqQuestions = [
  "Leva em consideração os sentimentos de outras pessoas",
  "É inquieto(a), agitado(a), não consegue ficar parado(a) por muito tempo",
  "Queixa-se frequentemente de dores de cabeça, dor de barriga, náuseas ou mal-estar",
  "Geralmente compartilha ou divide com outras crianças (doces, brinquedos, lápis, etc.)",
  "Tem crises de birra ou perde a calma com frequência",
  "É solitário(a), tende a brincar sozinho(a)",
  "Geralmente obedece ao que os adultos pedem",
  "Tem muitas preocupações, parece frequentemente preocupado(a)",
  "Ajuda quando alguém se machuca, fica chateado ou se sente mal",
  "Não sossega, está sempre mexendo as pernas ou as mãos",
  "Tem pelo menos um bom amigo/uma boa amiga",
  "Briga frequentemente com outras crianças ou provoca os outros",
  ...
  "Fica inseguro(a), nervoso(a) ou muito apegado(a) em lugares novos ou com pessoas desconhecidas",
  "É simpático(a) com crianças mais novas",
  "Mente ou engana frequentemente",
  "Outras crianças mexem com ele(a), ameaçam ou intimidam",
  "Oferece-se frequentemente para ajudar os outros (pais, professores, outras crianças)",
  "Pensa nas coisas antes de agir",
  "Pega coisas que não são suas em casa, na escola ou em outros lugares",
  "Relaciona-se melhor com adultos do que com outras crianças",
