...
export const sdqQuestions = [
  ...
  "É inquieto(a), hiperativo(a), não consegue ficar parado(a) por muito tempo",
  "Queixa-se frequentemente de dores de cabeça, dores de barriga ou náuseas",
  "Costuma compartilhar com outras crianças (doces, brinquedos, lápis, etc.)",
  "Faz birras ou tem mau gênio com frequência",
  "É solitário(a), tende a brincar sozinho(a)",
  "Normalmente segue o que os adultos pedem",
  "Tem muitas preocupações, parece frequentemente preocupado(a)",
  "Ajuda quando alguém se magoa, fica chateado ou se sente doente",
  "Não consegue ficar quieto(a), fica sempre mexendo nas pernas ou nas mãos",
  "Tem pelo menos um bom amigo/uma boa amiga",
  "Briga frequentemente com outras crianças ou provoca-as",
  ...
  "Outras crianças implicam com ele(a), ameaçam ou intimidam",
  "Costuma se oferecer para ajudar os outros (pais, professores, outras crianças)",
