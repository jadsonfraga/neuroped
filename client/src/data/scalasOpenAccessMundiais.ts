...
export const scalasOpenAccessMundiais: ScaleEntry[] = [
  ...
  },
  {
    ...
    prioridade: "triagem",
    tempo: "5 min",
    description: "Avaliação rápida de esvaziamento vesical disfuncional (10 itens).",
  ...
  },
  {
    ...
    prioridade: "triagem",
    tempo: "10–15 min",
    description: "Autorrelato de sintomas obsessivo-compulsivos em crianças (21 itens).",
  ...
  // ===== PSICOSE/EARLY PSYCHOSIS (4 escalas) =====
  {
    ...
    prioridade: "diagnostica",
    tempo: "30–40 min",
    description: "Entrevista para síndrome prodrômica de psicose. Apoiado por NIH.",
