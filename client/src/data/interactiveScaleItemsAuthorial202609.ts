...
const vigiaCalculate: ScaleConfig["onCalculate"] = (
  answers,
) => {
...
const nexoFamCalculate: ScaleConfig["onCalculate"] = (
  answers,
) => {
  let globalSum = 0;
  let globalValid = 0;
...
export const authorial202609OperationalItems: Record<
  string,
  InteractiveScaleDef
> = {
  "vigia-med-24": {
...
export const authorial202609Calculators: Record<string, ScaleConfig["onCalculate"]> = {
  "vigia-med-24": vigiaCalculate,
  "nexo-fam-24": nexoFamCalculate,
};
