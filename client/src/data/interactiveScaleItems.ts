...
export const interactiveScaleItems: Record<string, InteractiveScaleDef> = {
  ...
  "j26-212": { icon: Activity, gradient: "from-amber-500 to-orange-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação temporal de comportamentos restritivos e repetitivos no TEA (maior = mais/pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Comportamentos repetitivos — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Comportamentos restritivos", color: "text-amber-600 dark:text-amber-400", items: ["Tem estereotipias motoras","Insiste em rotinas fixas","Tem interesses restritos intensos","Tem comportamentos autoestimulativos","Resiste a mudanças","Cumpre rituais","Alinha ou gira objetos","Entra em crise se o ritual é interrompido"] }] },
  ...
  "j26-214": { icon: Hand, gradient: "from-violet-500 to-purple-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Evolução da integração sensorial no TEA após terapia ocupacional (maior = mais dificuldades remanescentes). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Dificuldades sensoriais — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Dificuldades sensoriais atuais", color: "text-violet-600 dark:text-violet-400", items: ["Hipersensibilidade tátil","Hipersensibilidade auditiva","Hipersensibilidade visual","Busca intensa de movimento","Seletividade oral-sensorial","Sobrecarga sensorial","Desregulação ligada ao sensorial","Impacto sensorial no cotidiano"] }] },
  "j26-215": { icon: ShieldAlert, gradient: "from-red-500 to-rose-600", instruction:
      "Marque a frequência de cada item no período. Responda todos os itens.",
    infoBox: "Comparação temporal da frequência de crises de desregulação emocional no TEA (maior = pior). Não é diagnóstico.",
    labels: FREQ_LABELS, totalLabel: "Crises de desregulação — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Crises de desregulação", color: "text-red-600 dark:text-red-400", items: ["Frequência das crises","Intensidade das crises","Duração das crises","Autoagressão na crise","Heteroagressão na crise","Dificuldade de recuperação","Crises por gatilho sensorial","Impacto das crises na família"] }] },
  ...
  "j26-219": { icon: Activity, gradient: "from-teal-500 to-cyan-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação pré e pós-medicação dos sintomas de TDAH (maior = mais sintomas). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Sintomas de TDAH — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Sintomas nucleares", color: "text-teal-600 dark:text-teal-400", items: ["Tem dificuldade de atenção","Comete erros por descuido","Tem agitação ou inquietação","Fala demais","Tem dificuldade de esperar","Interrompe os outros","Não termina as tarefas","Perde objetos"] }] },
  ...
  "j26-222": { icon: Activity, gradient: "from-cyan-500 to-blue-600", instruction:
      "Marque a frequência de cada efeito. Responda todos os itens.",
    infoBox: "Monitorização de efeitos do metilfenidato e da lisdexanfetamina (maior = mais efeitos). Relate ao médico. Não é diagnóstico.",
    labels: FREQ_LABELS, totalLabel: "Efeitos do estimulante — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Efeitos", color: "text-cyan-600 dark:text-cyan-400", items: ["Apetite reduzido","Insônia","Perda de peso","Dor de cabeça","Rebote ou irritabilidade","Tiques","Coração acelerado","Humor triste ou ansioso"] }] },
  ...
  "j26-224": { icon: Activity, gradient: "from-indigo-500 to-blue-700", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Acompanhamento de sono e apetite durante o tratamento do TDAH com estimulantes (maior = mais problemas). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Sono e apetite — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Sono e apetite", color: "text-indigo-600 dark:text-indigo-400", items: ["Demora para dormir","Dorme menos horas","Perde o apetite","Pula refeições","Perdeu peso","Acorda cansada","Tem rebote/irritabilidade à noite","Há impacto no crescimento"] }] },
  ...
  "j26-227": { icon: Activity, gradient: "from-violet-500 to-purple-700", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação mensal da frequência de crises epilépticas (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Crises epilépticas — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Carga de crises", color: "text-violet-600 dark:text-violet-400", items: ["Número de crises elevado","Crises longas","Crises noturnas","Crises em série","Quedas ou lesões nas crises","Pós-ictal prolongado","Precisou de pronto-socorro","Crises não controladas"] }] },
  "j26-228": { icon: Activity, gradient: "from-purple-500 to-fuchsia-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Monitorização de eficácia e efeitos colaterais dos antiepilépticos (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Antiepiléptico — eficácia/efeitos (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Eficácia e efeitos", color: "text-purple-600 dark:text-purple-400", items: ["As crises persistem (baixa eficácia)","Sonolência","Tontura","Irritabilidade","Náusea ou vômito","Lentidão cognitiva","Reação de pele (rash)","Alterações de humor"] }] },
  "j26-229": { icon: Sparkles, gradient: "from-amber-500 to-orange-600", instruction: DEV_INSTRUCTION,
    infoBox: "Acompanhamento cognitivo na epilepsia — memória, atenção e aprendizagem (maior = melhor). Não é diagnóstico.",
    labels: MILESTONE_LABELS, totalLabel: "Cognição na epilepsia — evolução (maior = melhor)", bands: DEV_BANDS,
    domains: [{ name: "Cognição", color: "text-amber-600 dark:text-amber-400", items: ["Tem boa memória","Tem boa atenção","Aprende bem","Tem raciocínio ágil","Tem bom rendimento escolar","É organizada","Acompanha a turma","Está alerta (sem sedação excessiva)"] }] },
  "j26-230": { icon: Heart, gradient: "from-blue-500 to-indigo-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação semestral da qualidade de vida na epilepsia (maior = mais impacto). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "QV na epilepsia — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Impacto na qualidade de vida", color: "text-blue-600 dark:text-blue-400", items: ["Atrapalha a escola","Atrapalha as amizades","Impõe restrições no dia a dia","Afeta a autoestima","Gera medo de crise","Há estigma","Gera ansiedade","Há impacto geral na vida"] }] },
  "j26-231": { icon: ClipboardList, gradient: "from-emerald-500 to-teal-600", instruction: DEV_INSTRUCTION,
    infoBox: "Adesão medicamentosa na epilepsia — barreiras e estratégias (maior = melhor adesão). Não é diagnóstico.",
    labels: MILESTONE_LABELS, totalLabel: "Adesão na epilepsia — evolução (maior = melhor)", bands: DEV_BANDS,
    domains: [{ name: "Adesão", color: "text-emerald-600 dark:text-emerald-400", items: ["Dá no horário certo","Não esquece doses","Dá a dose correta","Mantém o estoque","A criança aceita o remédio","Não interrompe por conta própria","Comparece às consultas","Faz os exames de acompanhamento"] }] },
  "j26-232": { icon: Activity, gradient: "from-slate-500 to-purple-700", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Registro de achados sequenciais de EEG na epilepsia (maior = mais alterado). Interpretação por especialista. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "EEG evolutivo (maior = mais alterado)", bands: SEVERITY_BANDS,
    domains: [{ name: "Achados de EEG", color: "text-slate-600 dark:text-slate-300", items: ["Atividade epileptiforme presente","Descargas frequentes","Lentificação do traçado","Foco persistente","Piora em relação ao exame anterior","Alterações generalizadas","Padrão desorganizado","Achados preocupantes no geral"] }] },
  ...
  "j26-236": { icon: MessageCircle, gradient: "from-orange-500 to-red-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Evolução da gagueira pós-fonoterapia (maior = pior/mais disfluência). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Gagueira — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Disfluência atual", color: "text-orange-600 dark:text-orange-400", items: ["Repete sons ou sílabas","Prolonga sons","Trava ou bloqueia","Tem tensão ao falar","Evita falar em certas situações","Tem ansiedade antecipatória","A gagueira atrapalha a comunicação","Piorou desde a última avaliação"] }] },
  ...
  "j26-241": { icon: Activity, gradient: "from-rose-500 to-red-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Registro sequencial da espasticidade (Ashworth modificada) — maior = pior. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Espasticidade — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Espasticidade", color: "text-rose-600 dark:text-rose-400", items: ["Tônus muscular aumentado","Resistência ao movimento passivo","Contraturas","Espasmos","Dor por espasticidade","Limitação funcional","Piorou desde a última avaliação","Impacto nas AVDs"] }] },
  ...
  "j26-249": { icon: ShieldAlert, gradient: "from-indigo-500 to-blue-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação sequencial da ansiedade pós-terapia (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Ansiedade — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Sintomas de ansiedade", color: "text-indigo-600 dark:text-indigo-400", items: ["Preocupa-se demais","Tem sintomas físicos de ansiedade","Evita situações temidas","Tem medo ou pânico","Fica tensa","Dorme mal por ansiedade","Tem ansiedade social","A ansiedade ainda atrapalha a rotina"] }] },
  "j26-250": { icon: Heart, gradient: "from-sky-500 to-indigo-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Comparação sequencial dos sintomas depressivos (maior = pior). Se houver piora ou risco, buscar avaliação. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Sintomas depressivos — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Sintomas depressivos", color: "text-sky-600 dark:text-sky-400", items: ["Tristeza","Perda de prazer (anedonia)","Baixa energia","Alterações de sono","Alterações de apetite","Baixa autoestima","Isolamento","Pensamentos negativos"] }] },
  "j26-251": { icon: ShieldAlert, gradient: "from-red-600 to-rose-700", instruction:
      "Avaliação clínica, com acolhimento. Marque a presença de cada item no período. Responda todos os itens.",
    infoBox: "Monitorização longitudinal de autolesão e ideação suicida. Itens positivos exigem avaliação de segurança imediata. Urgência: SAMU 192, CVV 188. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Autolesão/ideação — evolução (avaliar segurança)", bands: SEVERITY_BANDS,
    domains: [{ name: "Risco no período", color: "text-red-600 dark:text-red-400", items: ["Pensamentos de morte","Ideação suicida","Automutilação","Desesperança intensa","Planos de se machucar","Tentativa no período","Fatores de risco atuais (perda, conflito, abuso)","Necessidade de avaliação de segurança"] }] },
  "j26-252": { icon: ShieldAlert, gradient: "from-purple-500 to-fuchsia-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Resposta ao tratamento do TOC, no estilo Y-BOCS sequencial (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "TOC — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Obsessões e compulsões", color: "text-purple-600 dark:text-purple-400", items: ["Gasta muito tempo com obsessões","As obsessões interferem na rotina","As obsessões causam sofrimento","Gasta muito tempo com compulsões","As compulsões interferem na rotina","Tem pouca capacidade de resistir","Tem pouco controle sobre os sintomas","Há impacto geral importante"] }] },
  "j26-253": { icon: ShieldAlert, gradient: "from-slate-600 to-blue-800", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Evolução do TEPT pós-terapia, no estilo UCLA PTSD-RI sequencial (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "TEPT — evolução (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Sintomas pós-trauma", color: "text-slate-600 dark:text-slate-300", items: ["Reexperimentação (memórias, flashbacks)","Pesadelos","Evitação","Entorpecimento emocional","Hipervigilância","Sobressalto fácil","Culpa ou vergonha","Impacto na rotina"] }] },
  "j26-254": { icon: Heart, gradient: "from-pink-500 to-rose-600", instruction: DEV_INSTRUCTION,
    infoBox: "Acompanhamento transdiagnóstico da regulação emocional global (maior = melhor). Não é diagnóstico.",
    labels: MILESTONE_LABELS, totalLabel: "Regulação emocional global (maior = melhor)", bands: DEV_BANDS,
    domains: [{ name: "Regulação emocional", color: "text-pink-600 dark:text-pink-400", items: ["Reconhece as emoções","Nomeia o que sente","Consegue se acalmar","Tolera a frustração","Expressa sem agredir","Pede ajuda","Recupera-se após um abalo","Regula bem as emoções no geral"] }] },
  "j26-255": { icon: Activity, gradient: "from-orange-500 to-red-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Monitorização metabólica de antipsicóticos — peso, glicemia e lipídios (maior = pior). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Metabólica de antipsicóticos (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Perfil metabólico", color: "text-orange-600 dark:text-orange-400", items: ["Ganho de peso","Aumento do IMC","Glicemia elevada","Lipídios alterados","Pressão arterial elevada","Aumento da circunferência abdominal","Sinais de síndrome metabólica","Piorou desde a última avaliação"] }] },
  "j26-256": { icon: Activity, gradient: "from-amber-500 to-orange-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Acompanhamento de crescimento no uso de estimulantes — altura, peso e percentis (maior = mais impacto). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Impacto no crescimento (maior = mais)", bands: SEVERITY_BANDS,
    domains: [{ name: "Crescimento", color: "text-amber-600 dark:text-amber-400", items: ["Queda no percentil de peso","Queda no percentil de altura","Perda de apetite persistente","Baixo ganho de peso","Velocidade de crescimento reduzida","IMC abaixo do esperado","Preocupação com o crescimento","Considerar pausa do medicamento"] }] },
  "j26-257": { icon: Activity, gradient: "from-slate-500 to-gray-700", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Registro de ajuste de dose — equilíbrio entre eficácia e efeitos de qualquer psicofármaco (maior = mais necessidade de ajuste). Decisão com o médico. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Necessidade de ajuste (maior = mais)", bands: SEVERITY_BANDS,
    domains: [{ name: "Eficácia versus efeitos", color: "text-slate-600 dark:text-slate-300", items: ["Efeitos colaterais limitantes","Eficácia insuficiente na dose atual","Necessidade de aumento de dose","Necessidade de redução de dose","Efeitos no fim do dia (queda do efeito)","Janela terapêutica estreita","Dificuldade de equilibrar benefício e efeito","Necessidade de ajuste no geral"] }] },
  "j26-258": { icon: Activity, gradient: "from-violet-500 to-purple-600", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Monitorização hepática e hematológica de antiepilépticos por exames sequenciais (maior = mais alterado). Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Exames hepático/hematológico (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Achados laboratoriais", color: "text-violet-600 dark:text-violet-400", items: ["Transaminases elevadas","Alteração de bilirrubinas","Plaquetas baixas","Leucopenia","Anemia","Alteração de coagulação","Sinais clínicos (icterícia, sangramento)","Exame alterado em relação ao anterior"] }] },
  "j26-259": { icon: ClipboardList, gradient: "from-slate-500 to-gray-700", instruction: SEVERITY_INSTRUCTION,
    infoBox: "Impressão clínica global de gravidade e de melhora (CGI-S / CGI-I) — maior = mais grave/menos melhora. Não é diagnóstico.",
    labels: SEVERITY_LABELS, totalLabel: "Impressão clínica global (maior = pior)", bands: SEVERITY_BANDS,
    domains: [{ name: "Gravidade e melhora globais", color: "text-slate-600 dark:text-slate-300", items: ["Gravidade global atual elevada","Sintomas atuais intensos","Prejuízo funcional importante","Necessidade de tratamento intensivo","Piora em relação à última avaliação","Pouca melhora com o tratamento","Instabilidade do quadro","Quadro grave no geral"] }] },
