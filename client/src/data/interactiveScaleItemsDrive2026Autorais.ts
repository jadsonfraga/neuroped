...
import { sdgOperationalItems } from "./authorialSdgRegistry";
...
export const authorialDrive2026OperationalItems: Record<string, InteractiveScaleDef> = {
  ...
  "integra-neuroped-90": buildScale("integra-neuroped-90", ["development", "language", "attention", "executive", "learning", "behavior", "emotion", "sleep", "epilepsy", "functionality"], 10),
  ...
  "nefi-ped-96": buildScale("nefi-ped-96", ["development", "language", "attention", "executive", "learning", "behavior", "emotion", "sensory", "sleep", "epilepsy", "functionality"], 8),
  ...
  "mosaico-np-72": buildScale("mosaico-np-72", ["development", "language", "social", "attention", "executive", "learning", "behavior", "emotion", "sensory", "sleep", "epilepsy", "functionality", "family"], 6),
  ...
  "einpi-drj-v1": buildWithSentinels("einpi-drj-v1", ["development", "language", "social", "attention", "executive", "learning", "emotion", "sleep", "functionality"], 5, 8),
