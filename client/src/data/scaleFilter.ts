...
export interface ScaleEntry {
  ...
  description: string;
  // Phase 2 scale classification system (respondente_novo + tarefa_tipo)
  // Provides precise metadata for filtering, recommendations, and UI rendering
  respondente_novo?: string;  // 7-category respondent type from scaleClassification.ts
  tarefa_tipo?: string;       // 10-type task classification from scaleClassification.ts
...
export const scales: ScaleEntry[] = [
  ...
  { id: "denver", name: "Denver II", fullName: "Denver Developmental Screening Test II", ageMin: 0, ageMax: 72, queixas: ["atraso", "funcionalidade"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor", prioridade: "triagem", tempo: "15–20 min", signalTags: ["marcos do desenvolvimento", "motor", "linguagem", "pessoal-social", "atraso"], appRoute: "/denver", description: "Avalia marcos motores, linguagem, pessoal-social e motor fino-adaptativo.", fonte: "Frankenburg WK et al., 1992", validacaoBrasil: "Sim", scoringCutoff: "Avanço normal (dentro esperado); Cautela (75-90° percentil); Risco (abaixo 10º percentil)", licencaUso: "comercial" },
  { id: "bayley", name: "Bayley-III", fullName: "Bayley Scales of Infant Development III", ageMin: 1, ageMax: 42, queixas: ["atraso", "neonatal"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor", prioridade: "diagnostica", tempo: "30–90 min", description: "Padrão-ouro para avaliação cognitiva, motora e de linguagem em lactentes.", fonte: "Bayley N, 2006 - Pearson Clinical", validacaoBrasil: "Parcial", scoringCutoff: "composite score <85 abaixo do esperado", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/bayley"},
  { id: "griffiths", name: "Griffiths III", fullName: "Griffiths Scales of Child Development III", ageMin: 0, ageMax: 72, queixas: ["atraso"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor", prioridade: "diagnostica", tempo: "40–60 min", description: "Avalia 5 áreas: fundamentos da aprendizagem, linguagem, olho-mão, pessoal-social-emocional e motricidade grossa.", fonte: "Griffiths R, 2006 (Griffiths-3)", validacaoBrasil: "Parcial", scoringCutoff: "GQ Quotient ≥115 superior; 85-114 médio; <70 atraso moderado a severo", licencaUso: "comercial", appRoute: "/generic-scale/griffiths"},
  { id: "asq3", name: "ASQ-3", fullName: "Ages & Stages Questionnaire 3", ageMin: 1, ageMax: 66, queixas: ["atraso"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10–15 min", signalTags: ["comunicação", "motor grosso", "motor fino", "resolução de problemas", "pessoal-social", "marcos do desenvolvimento"], appRoute: "/asq3", description: "Triagem do desenvolvimento em 5 domínios com questionário para pais.", fonte: "Squires J & Bricker D, 2009", validacaoBrasil: "Sim", scoringCutoff: "Escore <cut-off por idade/domínio = encaminhamento recomendado; acima = desenvolvimento típico", licencaUso: "comercial" },
  { id: "peds", name: "PEDS", fullName: "Parents' Evaluation of Developmental Status", ageMin: 0, ageMax: 96, queixas: ["atraso"], respondente: ["pais"], prioridade: "triagem", tempo: "5 min", description: "10 perguntas de triagem respondidas pelos pais sobre preocupações com o desenvolvimento.", fonte: "Glascoe FP, 1997", validacaoBrasil: "Sim", scoringCutoff: "≥2 preocupações em qualquer domínio = encaminhamento para avaliação", licencaUso: "comercial", appRoute: "/generic-scale/peds", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "catclams", name: "CAT/CLAMS", fullName: "Clinical Adaptive Test / Clinical Linguistic and Auditory Milestone Scale", ageMin: 0, ageMax: 36, queixas: ["atraso", "linguagem"], respondente: ["clinico"], prioridade: "triagem", tempo: "15–20 min", description: "Avalia desenvolvimento cognitivo e de linguagem em crianças pequenas.", fonte: "Accardo PJ et al., 1992", validacaoBrasil: "Parcial", scoringCutoff: "Escore bruto convertido para age-equivalent (meses de desenvolvimento); gap >3 meses = atraso suspeito", licencaUso: "livre", signalTags: ["marcos cognitivos", "linguagem", "coordenação visomotora", "desenvolvimento"], appRoute: "/generic-scale/catclams", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  { id: "portage", name: "Portage", fullName: "Guia Portage de Educação Pré-Escolar / Inventário Operacionalizado (IPO)", ageMin: 0, ageMax: 72, queixas: ["atraso", "funcionalidade"], respondente: ["clinico"], prioridade: "triagem", tempo: "variável", description: "Inventário de habilidades do desenvolvimento (socialização, linguagem, autocuidado, cognição e motor) usado para planejar estimulação precoce de 0 a 6 anos.", fonte: "Bluma S et al., 1976; versão operacionalizada BR: Williams LCA & Aiello ALR", validacaoBrasil: "Sim (Inventário Portage Operacionalizado)", licencaUso: "comercial", signalTags: ["marcos do desenvolvimento", "estimulação precoce", "atraso", "funcionalidade"], appRoute: "/portage", implementationStatus: "external_only", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "observacao-comportamental" },
  { id: "aims", name: "AIMS", fullName: "Alberta Infant Motor Scale", ageMin: 0, ageMax: 18, queixas: ["atraso", "pc"], respondente: ["clinico"], prioridade: "triagem", tempo: "20 min", description: "Avalia desenvolvimento motor grosso de lactentes em posições prono, supino, sentado e de pé.", fonte: "Piper MC & Darrah J, 1994 - University of Alberta", validacaoBrasil: "Sim", scoringCutoff: "Percentis por idade; <10º percentil = atraso suspeito", licencaUso: "comercial", appRoute: "/generic-scale/aims", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor"},
  { id: "ims", name: "IMS", fullName: "Escala Motora Infantil de Alberta", ageMin: 0, ageMax: 18, queixas: ["atraso", "pc"], respondente: ["clinico"], prioridade: "triagem", tempo: "20 min", description: "Avaliação observacional do desenvolvimento motor grosso.", appRoute: "/generic-scale/ims", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor"},
  { id: "timp", name: "TIMP", fullName: "Test of Infant Motor Performance", ageMin: 0, ageMax: 4, queixas: ["atraso", "neonatal", "pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "25–35 min", description: "Avalia controle postural e motor em lactentes de risco.", appRoute: "/generic-scale/timp", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor"},
  { id: "gma", name: "GMA", fullName: "General Movements Assessment (Prechtl)", ageMin: 0, ageMax: 5, queixas: ["atraso", "neonatal", "pc"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental", prioridade: "triagem", tempo: "5–10 min", description: "Avaliação da qualidade dos movimentos generalizados do neonato. Padrão-ouro precoce para risco de PC.", fonte: "Prechtl HFR et al.", validacaoBrasil: "Sim", scoringCutoff: "ausência de fidgety movements sugere risco neurológico", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/gma"},

  // ===== TEA =====
  { id: "mchat", name: "M-CHAT-R/F", fullName: "Modified Checklist for Autism in Toddlers - Revised with Follow-Up", ageMin: 16, ageMax: 30, queixas: ["tea"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5–10 min", signalTags: ["contato ocular", "resposta ao nome", "apontar", "atenção compartilhada", "interesse social", "brincar simbólico", "estereotipias"], appRoute: "/mchat", description: "Rastreio de risco para TEA entre 16 e 30 meses.", fonte: "Robins DL et al., 2014 - Pediatrics", pubmedId: "PMID 24422648", validacaoBrasil: "Sim - Losapio MF et al., 2011", scoringCutoff: ">=3 risco inicial; >=8 alto risco; follow-up reduz falso-positivo", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "cars", name: "CARS-2", fullName: "Childhood Autism Rating Scale 2", ageMin: 24, ageMax: 216, queixas: ["tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", signalTags: ["relação interpessoal", "imitação", "resposta emocional", "adaptação a mudança", "comunicação verbal", "estereotipias"], appRoute: "/cars", description: "Classifica a gravidade dos sintomas do espectro autista.", fonte: "Schopler E et al., 2010", validacaoBrasil: "Parcial - adaptações brasileiras publicadas", scoringCutoff: ">=30 sugere TEA", licencaUso: "comercial", pendente_validacao_clinica: false, respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental" },
  { id: "ados2", name: "ADOS-2", fullName: "Autism Diagnostic Observation Schedule 2", ageMin: 12, ageMax: 216, queixas: ["tea"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "observacao-comportamental", prioridade: "diagnostica", tempo: "40–60 min", description: "Padrão-ouro observacional para diagnóstico de TEA. 5 módulos por nível de linguagem.", fonte: "Lord C et al., 2012 - Western Psychological Services", validacaoBrasil: "Parcial - uso clínico e estudos brasileiros", scoringCutoff: "algoritmos por módulo", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/ados2"},
  { id: "adir", name: "ADI-R", fullName: "Autism Diagnostic Interview - Revised", ageMin: 24, ageMax: 216, queixas: ["tea"], respondente: ["pais"], prioridade: "diagnostica", tempo: "90–150 min", description: "Entrevista semiestruturada com cuidadores. Padrão-ouro complementar ao ADOS-2.", fonte: "Rutter M et al., 2003", validacaoBrasil: "Parcial", scoringCutoff: "cutoffs por domínio diagnóstico", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/adir", respondente_novo: "questionario-parental", tarefa_tipo: "entrevista-estruturada"},
  { id: "scq", name: "SCQ", fullName: "Social Communication Questionnaire", ageMin: 48, ageMax: 216, queixas: ["tea"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", description: "40 itens derivados do ADI-R. Triagem rápida para TEA.", fonte: "Rutter M et al., 2003", validacaoBrasil: "Parcial", scoringCutoff: ">=15 sugere TEA", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/scq", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "srs2", name: "SRS-2", fullName: "Social Responsiveness Scale 2", ageMin: 30, ageMax: 216, queixas: ["tea"], respondente: ["pais", "professor"], respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "15–20 min", description: "Quantifica déficits de responsividade social associados ao TEA.", fonte: "Constantino JN, Gruber CP, 2012", validacaoBrasil: "Sim - adaptação brasileira disponível", scoringCutoff: "T-score >=60 sugere alterações sociais", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/srs2"},
  { id: "cast", name: "CAST", fullName: "Childhood Autism Spectrum Test", ageMin: 48, ageMax: 132, queixas: ["tea"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", description: "37 itens para triagem de TEA em idade escolar.", fonte: "Scott FJ et al., 2002", pubmedId: "PMID 12199139", validacaoBrasil: "Parcial", scoringCutoff: ">=15 risco aumentado", licencaUso: "contato_autor", pendente_validacao_clinica: false, appRoute: "/generic-scale/cast", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "gars3", name: "GARS-3", fullName: "Gilliam Autism Rating Scale 3", ageMin: 36, ageMax: 216, queixas: ["tea"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "10–15 min", description: "Avalia comportamentos restritos/repetitivos, interação social e comunicação.", appRoute: "/generic-scale/gars3", respondente_novo: "misto", tarefa_tipo: "questionario-fechado"},
  { id: "atec", name: "ATEC", fullName: "Autism Treatment Evaluation Checklist", ageMin: 18, ageMax: 216, queixas: ["tea", "social", "linguagem", "comportamento"], respondente: ["pais", "clinico"], prioridade: "monitorizacao", tempo: "10–15 min", description: "Triagem e acompanhamento de sinais do espectro autista em 4 domínios (comunicação, sociabilidade, consciência sensorial/cognitiva, saúde/comportamento). Formato de monitoramento preenchível.", fonte: "Rimland B & Edelson SM — Autism Research Institute (ATEC)", validacaoBrasil: "Instrumento amplamente usado em português; formato de monitoramento adaptado", scoringCutoff: "Maior % do escore = maior preocupação; usar para acompanhamento longitudinal, não diagnóstico", licencaUso: "livre", assessmentUse: "monitorizacao", applicationMode: "questionario_pais", implementationStatus: "complete", signalTags: ["contato ocular", "resposta ao nome", "linguagem", "comunicação", "estereotipias", "rigidez", "birras", "seletividade alimentar", "sono", "socialização"], appRoute: "/generic-scale/atec", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "aq10-adolescente", name: "AQ-10 Adolescente", fullName: "Autism Spectrum Quotient — 10 itens (adolescente)", ageMin: 144, ageMax: 216, queixas: ["tea", "social"], respondente: ["autoaplicavel", "pais"], prioridade: "triagem", tempo: "3–5 min", description: "Rastreio rápido (10 itens) de traços do espectro autista em adolescentes. Corte ≥6/10 sugere encaminhamento para avaliação.", fonte: "Allison C, Auyeung B, Baron-Cohen S, 2012 (AQ-10)", validacaoBrasil: "Adaptado para triagem em português", scoringCutoff: "≥6 de 10 = rastreio positivo (encaminhar)", licencaUso: "livre", assessmentUse: "triagem", applicationMode: "autoquestionario_crianca_adolescente", implementationStatus: "complete", verbalRequirement: "verbal", literacyRequirement: "alfabetizado", signalTags: ["traços autistas", "socialização", "rotina", "interesses restritos", "literalidade", "amizades"], appRoute: "/generic-scale/aq10-adolescente", respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado"},
  { id: "assq", name: "ASSQ", fullName: "Autism Spectrum Screening Questionnaire", ageMin: 84, ageMax: 204, queixas: ["tea"], respondente: ["pais", "professor"], prioridade: "triagem", tempo: "10 min", description: "27 itens para triagem de TEA de alto funcionamento / Asperger.", fonte: "Ehlers S et al., 1999", pubmedId: "PMID 10382131", validacaoBrasil: "Sim", scoringCutoff: ">=19 sugere risco", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/assq", respondente_novo: "misto", tarefa_tipo: "questionario-fechado"},
  { id: "tea-checklists", name: "Checklists TEA", fullName: "ADOS-2, ADI-R, CARS-2, GARS-3, SRS-2 — Resumo Clínico", ageMin: 12, ageMax: 216, queixas: ["tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "Variável", signalTags: ["contato ocular", "atenção compartilhada", "linguagem", "interesse social", "estereotipias", "rotina"], appRoute: "/tea", description: "Checklists clínicos adaptados dos 5 principais instrumentos de TEA.", respondente_novo: "questionario-profissional", tarefa_tipo: "questionario-fechado" },
  { id: "tea-comportamentos", name: "Comport. Atípicos TEA", fullName: "Escala de Comportamentos Atípicos em TEA — 6 Faixas Etárias", ageMin: 0, ageMax: 216, queixas: ["tea", "comportamento"], respondente: ["clinico", "pais"], prioridade: "diagnostica", tempo: "15–25 min", signalTags: ["estereotipias", "rigidez", "interesses restritos", "sensorialidade", "birras"], appRoute: "/tea-comportamentos", description: "100 itens observacionais em 6 domínios, por faixa etária (0–18 anos).", respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental" },
  { id: "podj-tea-prime-familiar", name: "PODJ-TEA Familiar", fullName: "PODJ-TEA PRIME — Ficha de Entrevista Familiar", ageMin: 12, ageMax: 216, queixas: ["tea", "social", "linguagem", "sensorial", "funcionalidade"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "10–20 min", description: "Ficha complementar por paciente para colher exemplos familiares de história inicial, regressão, linguagem, atenção compartilhada, socialização, brincadeira, rigidez, RRB, sensorialidade, funcionalidade, diferenciais, camuflagem e evolução. Não substitui avaliação diagnóstica formal.", fonte: "PODJ-TEA PRIME — Kit Fichas por Paciente, Dr. Jadson Fraga", licencaUso: "autoral", validacaoBrasil: "Autoral — ficha complementar observacional", scoringCutoff: "Pontuação qualitativa 0 adequado; 1 discreto; 2 claro/moderado; 3 intenso/importante; NO/NA quando não observado/não aplicável", appRoute: "/generic-scale/podj-tea-prime-familiar", applicationMode: "entrevista_clinica", assessmentUse: "diagnostico" },
  { id: "podj-tea-prime-escola-terapia", name: "PODJ-TEA Escola/Terapia", fullName: "PODJ-TEA PRIME — Ficha Escola / Terapia", ageMin: 24, ageMax: 216, queixas: ["tea", "social", "linguagem", "sensorial", "funcionalidade", "aprendizagem"], respondente: ["professor", "clinico"], prioridade: "diagnostica", tempo: "10–20 min", description: "Ficha complementar para escola ou terapia com foco em socialização, reciprocidade, pragmática, rotina, regras, hiperfoco, sensorialidade, funcionalidade e forças observadas em contexto real. Útil para documentar pervasividade e impacto funcional fora do consultório.", fonte: "PODJ-TEA PRIME — Kit Fichas por Paciente, Dr. Jadson Fraga", licencaUso: "autoral", validacaoBrasil: "Autoral — ficha complementar observacional", scoringCutoff: "Registro por frequência, impacto, exemplo observado e contexto; usar como evidência complementar, não como diagnóstico isolado", appRoute: "/generic-scale/podj-tea-prime-escola-terapia", applicationMode: "questionario_professor", assessmentUse: "diagnostico" },
  { id: "podj-tea-prime-1-6a", name: "PODJ-TEA PRIME 1–6A", fullName: "PODJ-TEA PRIME — Ficha de Aplicação 1–6A", ageMin: 12, ageMax: 71, queixas: ["tea", "atraso", "linguagem", "social", "sensorial", "funcionalidade"], respondente: ["clinico", "pais"], prioridade: "diagnostica", tempo: "20–30 min", description: "Ficha observacional para 12 meses a 5 anos e 11 meses, organizada para consulta, escola, terapia ou avaliação estruturada. Abrange atenção compartilhada, comunicação social, brincadeira, criatividade lúdica, interesses incomuns, rigidez, sensorialidade, seletividade alimentar, funcionalidade e fechamento por pervasividade, impacto e confiabilidade.", fonte: "PODJ-TEA PRIME — Kit Fichas por Paciente, Dr. Jadson Fraga", licencaUso: "autoral", validacaoBrasil: "Autoral — ficha complementar observacional", scoringCutoff: "0 adequado; 1 discreto; 2 claro/moderado; 3 intenso/importante; registrar ajuda A0-A4 e exemplos objetivos", appRoute: "/generic-scale/podj-tea-prime-1-6a", applicationMode: "observacional_clinico", assessmentUse: "diagnostico", verbalRequirement: "nao_verbal_compativel", literacyRequirement: "pre_alfabetizado" },
  ...
  { id: "podj-tea-prime-12-19a", name: "PODJ-TEA PRIME 12–19A", fullName: "PODJ-TEA PRIME — Ficha de Aplicação 12–19A", ageMin: 144, ageMax: 216, queixas: ["tea", "social", "linguagem", "sensorial", "funcionalidade", "ansiedade"], respondente: ["clinico", "pais", "autoaplicavel"], prioridade: "diagnostica", tempo: "20–30 min", description: "Ficha observacional para 12 a 19 anos, com foco em reciprocidade social, amizades, julgamento social, vulnerabilidade/ingenuidade, camuflagem, flexibilidade, tolerância à incerteza, sensorialidade, autonomia, funcionalidade escolar/global, sofrimento, exaustão social e necessidade de plano de proteção quando indicado.", fonte: "PODJ-TEA PRIME — Kit Fichas por Paciente, Dr. Jadson Fraga", licencaUso: "autoral", validacaoBrasil: "Autoral — ficha complementar observacional", scoringCutoff: "0 adequado; 1 discreto; 2 claro/moderado; 3 intenso/importante; correlacionar com entrevista, escola/família e diferenciais clínicos", appRoute: "/generic-scale/podj-tea-prime-12-19a", applicationMode: "observacional_clinico", assessmentUse: "diagnostico", literacyRequirement: "indiferente", suicideRiskInstrument: true },

  // ===== TDAH =====
  { id: "snap", name: "SNAP-IV", fullName: "Swanson, Nolan and Pelham Rating Scale IV", ageMin: 72, ageMax: 204, queixas: ["tdah"], respondente: ["pais", "professor"], respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", signalTags: ["desatenção", "hiperatividade", "impulsividade", "não termina tarefas", "distrai-se facilmente", "agitação", "oposição"], appRoute: "/snap", description: "Avalia desatenção e hiperatividade/impulsividade — 18 itens DSM.", fonte: "Swanson JM et al., 2001 - University of California", validacaoBrasil: "Sim", scoringCutoff: ">=6 sintomas frequentes por domínio", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "conners", name: "Conners 3", fullName: "Conners Rating Scales 3", ageMin: 72, ageMax: 216, queixas: ["tdah", "comportamento"], respondente: ["pais", "professor", "autoaplicavel"], respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado", prioridade: "diagnostica", tempo: "15–20 min", signalTags: ["desatenção", "hiperatividade", "impulsividade", "oposição", "problemas de aprendizagem"], appRoute: "/conners", description: "Problemas de conduta, aprendizagem, queixas somáticas e impulsividade.", fonte: "Conners CK, 2008 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 clinicamente relevante", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "vanderbilt", name: "Vanderbilt", fullName: "NICHQ Vanderbilt Assessment Scale", ageMin: 72, ageMax: 144, queixas: ["tdah", "comportamento"], respondente: ["pais", "professor"], prioridade: "triagem", tempo: "10–15 min", signalTags: ["desatenção", "hiperatividade", "impulsividade", "oposição", "conduta", "desempenho escolar"], appRoute: "/vanderbilt", description: "Escala para pais com domínios de desatenção, hiperatividade e conduta.", respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado" },
  { id: "brief2", name: "BRIEF-2", fullName: "Behavior Rating Inventory of Executive Function 2", ageMin: 60, ageMax: 216, queixas: ["tdah", "cognicao"], respondente: ["pais", "professor"], respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado", prioridade: "diagnostica", tempo: "10–15 min", signalTags: ["inibição", "flexibilidade", "memória de trabalho", "planejamento", "organização", "autocontrole"], appRoute: "/brief2", description: "Inibição, flexibilidade, controle emocional, memória de trabalho e planejamento.", fonte: "Gioia GA et al., 2015", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 elevado", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "barkley", name: "Barkley", fullName: "Barkley Functional Impairment Scale - Children", ageMin: 72, ageMax: 216, queixas: ["tdah"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "10 min", description: "Avalia prejuízo funcional associado ao TDAH em múltiplos contextos.", appRoute: "/generic-scale/barkley", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "brown-add", name: "Brown ADD", fullName: "Brown Attention-Deficit Disorder Scales", ageMin: 36, ageMax: 216, queixas: ["tdah"], respondente: ["clinico", "autoaplicavel"], prioridade: "diagnostica", tempo: "15–20 min", description: "Avalia funções executivas e atenção com foco em aspectos cognitivos do TDAH.", appRoute: "/generic-scale/brown-add", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},

  // ===== COMPORTAMENTO =====
  { id: "cbcl", name: "CBCL", fullName: "Child Behavior Checklist (1.5-5 e 6-18)", ageMin: 18, ageMax: 216, queixas: ["comportamento", "tdah", "ansiedade", "depressao"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "15–20 min", signalTags: ["internalizante", "externalizante", "ansiedade/depressão", "agressividade", "atenção", "queixas somáticas", "problemas sociais"], appRoute: "/cbcl", description: "Triagem de problemas internalizantes, externalizantes e sociais. Cobre as versões 1.5-5 e 6-18.", fonte: "Achenbach TM & Rescorla LA, 2001", validacaoBrasil: "Sim - Bordin IAS et al.", scoringCutoff: "T-score >=64 clínico", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "sdq", name: "SDQ", fullName: "Strengths and Difficulties Questionnaire", ageMin: 24, ageMax: 204, queixas: ["comportamento", "tdah", "ansiedade", "social"], respondente: ["pais", "professor", "autoaplicavel", "crianca"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5–10 min", signalTags: ["sintomas emocionais", "hiperatividade", "problemas de conduta", "relacionamento com pares", "comportamento pró-social"], appRoute: "/sdq", description: "Comportamento pró-social, hiperatividade, emoções, conduta e pares.", fonte: "Goodman R, 1997 - Cambridge University", pubmedId: "PMID 9255702", validacaoBrasil: "Sim - Fleitlich-Bilyk B et al.", scoringCutoff: "score total >=17 alterado", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "abc", name: "ABC", fullName: "Aberrant Behavior Checklist", ageMin: 36, ageMax: 216, queixas: ["comportamento", "tea"], respondente: ["pais", "clinico"], respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado", prioridade: "monitorizacao", tempo: "10–15 min", signalTags: ["irritabilidade", "letargia", "estereotipias", "hiperatividade", "fala inapropriada"], appRoute: "/abc", description: "Irritabilidade, letargia, estereotipia, hiperatividade e fala inadequada." },
  { id: "ecbi", name: "ECBI", fullName: "Eyberg Child Behavior Inventory", ageMin: 24, ageMax: 192, queixas: ["comportamento"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", description: "36 itens de problemas de conduta com escalas de intensidade e problema.", fonte: "Eyberg SM & Ross AW, 1978", validacaoBrasil: "Sim", scoringCutoff: "Intensidade >131; Problema >11 = clínicamente significativo", licencaUso: "comercial", appRoute: "/generic-scale/ecbi"},
  { id: "psc17", name: "PSC-17", fullName: "Pediatric Symptom Checklist 17", ageMin: 48, ageMax: 192, queixas: ["comportamento", "ansiedade", "depressao"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5 min", description: "Triagem breve de problemas psicossociais em pediatria.", signalTags: ["internalizante", "atenção", "externalizante", "carga psicossocial"], appRoute: "/generic-scale/psc17"},
  { id: "hsq", name: "HSQ", fullName: "Home Situations Questionnaire", ageMin: 48, ageMax: 144, queixas: ["comportamento", "tdah"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "5 min", description: "Avalia problemas de comportamento em 16 situações domésticas.", appRoute: "/generic-scale/hsq", respondente_novo: "questionario-escolar", tarefa_tipo: "questionario-fechado"},
  { id: "psi", name: "PSI", fullName: "Parenting Stress Index", ageMin: 0, ageMax: 144, queixas: ["comportamento", "funcionalidade"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "12–15 min", description: "Mede o estresse parental no sistema pai-criança (domínios da criança, dos pais e situacional). Útil para planejar intervenção familiar.", fonte: "Abidin RR, 1995 (Parenting Stress Index)", validacaoBrasil: "Parcial", scoringCutoff: "percentil >=85 estresse clinicamente significativo", licencaUso: "comercial", appRoute: "/generic-scale/psi"},

  // ===== ANSIEDADE =====
  { id: "scared", name: "SCARED", fullName: "Screen for Child Anxiety Related Disorders", ageMin: 96, ageMax: 216, queixas: ["ansiedade"], respondente: ["pais", "autoaplicavel", "crianca"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", signalTags: ["ansiedade", "pânico", "ansiedade de separação", "fobia social", "evitação", "preocupação", "queixas somáticas"], appRoute: "/scared", description: "Pânico, ansiedade generalizada, separação, fobia social e evitação escolar.", fonte: "Birmaher B et al., 1997 - University of Pittsburgh", pubmedId: "PMID 9136490", validacaoBrasil: "Sim", scoringCutoff: ">=25 sugere transtorno ansioso", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "masc2", name: "MASC-2", fullName: "Multidimensional Anxiety Scale for Children 2", ageMin: 96, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel", "pais"], prioridade: "diagnostica", tempo: "15 min", description: "50 itens em 4 escalas: ansiedade física, evitação de dano, ansiedade social e separação/pânico.", fonte: "March JS, 2013", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/masc2", respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado"},
  { id: "rcads", name: "RCADS", fullName: "Revised Children's Anxiety and Depression Scale", ageMin: 96, ageMax: 216, queixas: ["ansiedade", "depressao"], respondente: ["autoaplicavel", "pais", "crianca"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", description: "47 itens cobrindo 6 subescalas baseadas no DSM (ansiedade e depressão).", fonte: "Chorpita BF et al., 2000 - Journal of the American Academy of Child & Adolescent Psychiatry", validacaoBrasil: "Parcial", scoringCutoff: "Total ≥63 provável transtorno; subescalas interpretadas conforme T-score", licencaUso: "livre", signalTags: ["ansiedade", "depressão", "pânico", "ansiedade de separação", "fobia social", "humor deprimido"], appRoute: "/generic-scale/rcads"},
  { id: "scas", name: "SCAS", fullName: "Spence Children's Anxiety Scale", ageMin: 36, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel", "pais"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", description: "Avalia 6 domínios de ansiedade: separação, social, obsessões, pânico, generalizada, medo de lesão.", signalTags: ["ansiedade", "pânico", "ansiedade de separação", "fobia social", "medos específicos", "obsessões"], appRoute: "/generic-scale/scas"},
  { id: "staic", name: "STAIC", fullName: "State-Trait Anxiety Inventory for Children", ageMin: 72, ageMax: 168, queixas: ["ansiedade"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "diagnostica", tempo: "10 min", description: "Diferencia ansiedade-estado (transitória) de ansiedade-traço (tendência estável).", appRoute: "/generic-scale/staic"},
  { id: "gad7ped", name: "GAD-7 Pediátrico", fullName: "Generalized Anxiety Disorder 7 — Versão Pediátrica", ageMin: 144, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "3 min", description: "7 itens de triagem rápida para ansiedade generalizada.", fonte: "Spitzer RL et al., 2006", pubmedId: "PMID 16717171", validacaoBrasil: "Sim", scoringCutoff: ">=10 ansiedade moderada", licencaUso: "livre", pendente_validacao_clinica: false, signalTags: ["preocupação", "nervosismo", "irritabilidade", "tensão", "inquietação"], appRoute: "/gad7", implementationStatus: "complete"},

  // ===== DEPRESSÃO =====
  { id: "cdi2", name: "CDI-2", fullName: "Children's Depression Inventory 2", ageMin: 84, ageMax: 204, queixas: ["depressao"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10–15 min", signalTags: ["humor deprimido", "anedonia", "autoestima", "ineficácia", "sintomas negativos"], appRoute: "/cdi2", description: "Inventário de Depressão Infantil — 28 itens.", fonte: "Kovacs M, 2011 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "phqa", name: "PHQ-A", fullName: "Patient Health Questionnaire - Adolescentes", ageMin: 132, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5 min", signalTags: ["humor deprimido", "anedonia", "sono", "apetite", "ideação suicida"], appRoute: "/phqa", description: "9 itens para triagem de depressão em adolescentes.", fonte: "Johnson JG et al., 2002", pubmedId: "PMID 12090817", validacaoBrasil: "Parcial", scoringCutoff: ">=10 depressao moderada", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "mfq", name: "MFQ", fullName: "Mood and Feelings Questionnaire", ageMin: 72, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel", "pais"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", description: "33 itens avaliando humor depressivo nas últimas 2 semanas.", signalTags: ["humor deprimido", "tristeza", "choro", "desânimo", "autocrítica"], appRoute: "/generic-scale/mfq"},
  { id: "cdrsr", name: "CDRS-R", fullName: "Children's Depression Rating Scale - Revised", ageMin: 72, ageMax: 144, queixas: ["depressao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "17 itens aplicados pelo clínico. Padrão-ouro para gravidade de depressão infantil.", appRoute: "/generic-scale/cdrsr", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada"},
  { id: "rads2", name: "RADS-2", fullName: "Reynolds Adolescent Depression Scale 2", ageMin: 132, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "diagnostica", tempo: "10 min", description: "30 itens de autoaplicação para depressão na adolescência.", appRoute: "/generic-scale/rads2"},

  // ===== EPILEPSIA =====
  { id: "epilepsia-diario", name: "Diário de Crises", fullName: "Diário de Crises Epilépticas — Registro e Acompanhamento", ageMin: 0, ageMax: 216, queixas: ["epilepsia"], respondente: ["pais", "clinico"], prioridade: "monitorizacao", tempo: "5 min/registro", signalTags: ["frequência de crises", "tipo de crise", "duração", "gatilhos", "aura", "pós-ictal"], appRoute: "/epilepsia", description: "Registro de tipo, duração, consciência, triggers e pós-ictal.", respondente_novo: "questionario-parental", tarefa_tipo: "diario-registro" },
  { id: "qvce50", name: "QVCE-50", fullName: "Qualidade de Vida da Criança com Epilepsia", ageMin: 24, ageMax: 216, queixas: ["epilepsia"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "15 min", description: "50 itens sobre impacto da epilepsia na qualidade de vida.", appRoute: "/generic-scale/qvce50", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "hine", name: "HINE", fullName: "Hammersmith Infant Neurological Examination", ageMin: 2, ageMax: 24, queixas: ["epilepsia", "neonatal", "pc"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental", prioridade: "diagnostica", tempo: "10–15 min", description: "Exame neurológico padronizado para lactentes — 26 itens.", fonte: "Dubowitz L et al., 2008", validacaoBrasil: "Parcial", scoringCutoff: "26 itens objetivos com padrões normal/anormal; anormalidades precoces sugerem lesão neurológica", licencaUso: "livre", signalTags: ["postura", "tônus", "movimentos", "reflexos primitivos", "reações posturais", "nervos cranianos"], appRoute: "/generic-scale/hine"},
  { id: "pedsql-epilepsia", name: "PedsQL Epilepsia", fullName: "PedsQL Epilepsy Module", ageMin: 24, ageMax: 216, queixas: ["epilepsia"], respondente: ["pais", "autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "Módulo específico de epilepsia do PedsQL.", appRoute: "/generic-scale/pedsql-epilepsia", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "qolie-ad", name: "QOLIE-AD-48", fullName: "Quality of Life in Epilepsy - Adolescent", ageMin: 132, ageMax: 216, queixas: ["epilepsia"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "15 min", description: "Qualidade de vida em epilepsia para adolescentes — 48 itens.", appRoute: "/generic-scale/qolie-ad", respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado"},
  { id: "nddie", name: "NDDI-E", fullName: "Neurological Disorders Depression Inventory for Epilepsy", ageMin: 132, ageMax: 216, queixas: ["epilepsia", "depressao"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "3 min", description: "6 itens de triagem de depressão em pacientes com epilepsia.", signalTags: ["humor deprimido", "epilepsia", "irritabilidade", "anedonia"], appRoute: "/generic-scale/nddie", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},

  // ===== PARALISIA CEREBRAL / MOTOR =====
  { id: "gmfcs", name: "GMFCS", fullName: "Gross Motor Function Classification System", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "diagnostica", tempo: "5 min", signalTags: ["função motora grossa", "marcha", "mobilidade", "uso de cadeira", "níveis funcionais"], appRoute: "/gmfcs", description: "Classificação da função motora grossa em PC — 5 níveis.", fonte: "Palisano R et al., 2007", validacaoBrasil: "Sim", scoringCutoff: "Nível I: marcha sem restrição; II: marcha com limitações; III: requer assistência; IV: mobilidade motorizada; V: transportado", licencaUso: "livre" },
  { id: "gmfm", name: "GMFM-88/66", fullName: "Gross Motor Function Measure", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "45–60 min", description: "88 itens em 5 dimensões motoras. Padrão-ouro para medir função motora na PC.", fonte: "Russell DJ et al., 2002", validacaoBrasil: "Sim", scoringCutoff: "Escore 0-100% por dimensão; <50% inibição grave; >80% próximo ao normal", licencaUso: "comercial", appRoute: "/generic-scale/gmfm", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor"},
  { id: "macs", name: "MACS", fullName: "Manual Ability Classification System", ageMin: 48, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "diagnostica", tempo: "5 min", description: "Classifica habilidade manual na PC em 5 níveis.", appRoute: "/generic-scale/macs"},
  { id: "cfcs", name: "CFCS", fullName: "Communication Function Classification System", ageMin: 24, ageMax: 216, queixas: ["pc", "linguagem"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "diagnostica", tempo: "5 min", description: "Classifica a eficácia da comunicação na PC em 5 níveis.", appRoute: "/generic-scale/cfcs"},
  { id: "edacs", name: "EDACS", fullName: "Eating and Drinking Ability Classification System", ageMin: 36, ageMax: 216, queixas: ["pc", "alimentacao"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "diagnostica", tempo: "5 min", description: "Classifica habilidade alimentar na PC em 5 níveis.", appRoute: "/generic-scale/edacs"},
  { id: "ashworth", name: "Ashworth Modificada", fullName: "Escala de Ashworth Modificada", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "monitorizacao", tempo: "5–10 min", description: "Avalia espasticidade muscular em escala 0–4 (Ashworth + Tardieu).", signalTags: ["espasticidade", "tônus muscular", "resistência ao movimento", "hipertonia"], appRoute: "/espasticidade", implementationStatus: "complete", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-motor"},

  // ===== LINGUAGEM =====
  { id: "cdi-macarthur", name: "CDI MacArthur", fullName: "MacArthur-Bates Communicative Development Inventories", ageMin: 8, ageMax: 37, queixas: ["linguagem", "atraso"], respondente: ["pais"], prioridade: "triagem", tempo: "20–30 min", description: "Inventário de vocabulário e gestos comunicativos para lactentes e crianças pequenas.", fonte: "Fenson L et al., 2007 - Brookes Publishing", validacaoBrasil: "Sim", scoringCutoff: "Vocabulário <10º percentil para idade = atraso suspeito; <25º = monitorar", licencaUso: "comercial", appRoute: "/generic-scale/cdi-macarthur", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "reel3", name: "REEL-3", fullName: "Receptive-Expressive Emergent Language Test 3", ageMin: 0, ageMax: 36, queixas: ["linguagem", "atraso"], respondente: ["clinico", "pais"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia linguagem receptiva e expressiva emergente de 0 a 3 anos.", appRoute: "/generic-scale/reel3", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  { id: "celf5", name: "CELF-5", fullName: "Clinical Evaluation of Language Fundamentals 5", ageMin: 60, ageMax: 216, queixas: ["linguagem", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–60 min", description: "Avaliação abrangente de linguagem receptiva e expressiva.", appRoute: "/generic-scale/celf5", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  { id: "ppvt4", name: "PPVT-4", fullName: "Peabody Picture Vocabulary Test 4", ageMin: 30, ageMax: 216, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15 min", description: "Vocabulário receptivo por identificação de figuras.", appRoute: "/generic-scale/ppvt4", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},

  // ===== SONO =====
  { id: "cshq", name: "CSHQ", fullName: "Children's Sleep Habits Questionnaire", ageMin: 48, ageMax: 120, queixas: ["sono"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10–15 min", signalTags: ["resistência para dormir", "despertares noturnos", "sonolência diurna", "ronco", "rotina de sono"], appRoute: "/cshq", description: "Hábitos de sono infantil — 7 domínios de distúrbio.", fonte: "Owens JA et al., 2000", pubmedId: "PMID 11174669", validacaoBrasil: "Sim", scoringCutoff: ">41 distúrbio do sono provável", licencaUso: "restrita", pendente_validacao_clinica: false },
  { id: "bisq", name: "BISQ", fullName: "Brief Infant Sleep Questionnaire", ageMin: 0, ageMax: 36, queixas: ["sono"], respondente: ["pais"], prioridade: "triagem", tempo: "5 min", description: "Triagem breve de padrões de sono em lactentes.", signalTags: ["despertares noturnos", "latência do sono", "local de dormir", "sono do lactente"], appRoute: "/generic-scale/bisq", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "bears", name: "BEARS", fullName: "Bedtime, Excessive Daytime Sleepiness, Awakenings, Regularity, Snoring", ageMin: 24, ageMax: 216, queixas: ["sono"], respondente: ["pais", "autoaplicavel"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5 min", description: "5 perguntas-chave para triagem de distúrbios do sono.", fonte: "Owens JA & Dalzell V, 2005 - Brown University", pubmedId: "PMID 15764706", validacaoBrasil: "Parcial", scoringCutoff: "triagem qualitativa sem cutoff único", licencaUso: "livre", pendente_validacao_clinica: false, signalTags: ["resistência ao sono", "sonolência diurna", "despertares noturnos", "ronco", "regularidade do sono"], appRoute: "/generic-scale/bears"},
  { id: "sdsc", name: "SDSC", fullName: "Sleep Disturbance Scale for Children", ageMin: 72, ageMax: 180, queixas: ["sono"], respondente: ["pais"], prioridade: "diagnostica", tempo: "10 min", description: "26 itens em 6 categorias de distúrbio do sono.", fonte: "Bruni O et al., 1996", pubmedId: "PMID 8989069", validacaoBrasil: "Sim", scoringCutoff: "T-score >70", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/sdsc", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "psq", name: "PSQ", fullName: "Pediatric Sleep Questionnaire", ageMin: 24, ageMax: 216, queixas: ["sono"], respondente: ["pais"], respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "10 min", description: "Triagem de distúrbios respiratórios do sono e sonolência.", fonte: "Chervin RD et al., 2000 - University of Michigan", validacaoBrasil: "Parcial", scoringCutoff: "escores brutos interpretados; ≥0.33 prevalência suspeita de apneia", licencaUso: "comercial", appRoute: "/generic-scale/psq"},

  // ===== ALIMENTAÇÃO =====
  { id: "soma", name: "SOMA", fullName: "Schedule for Oral Motor Assessment", ageMin: 8, ageMax: 24, queixas: ["alimentacao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avaliação padronizada da função motora oral durante alimentação.", appRoute: "/generic-scale/soma", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "eda", name: "EDA", fullName: "Escala de Dificuldade Alimentar", ageMin: 6, ageMax: 72, queixas: ["alimentacao"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", description: "Triagem de dificuldades alimentares na primeira infância.", appRoute: "/generic-scale/eda", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},

  // ===== DOR / CEFALEIA =====
  { id: "cefaleia-calendario", name: "Calendário de Cefaleia", fullName: "Calendário de Cefaleia — Registro Diário", ageMin: 36, ageMax: 216, queixas: ["dor"], respondente: ["pais", "autoaplicavel"], prioridade: "monitorizacao", tempo: "5 min/registro", signalTags: ["cefaleia", "frequência", "intensidade", "duração", "gatilhos", "medicação"], appRoute: "/cefaleia", description: "Intensidade, tipo, localização, aura, triggers e resposta medicamentosa.", respondente_novo: "questionario-parental", tarefa_tipo: "diario-registro" },
  { id: "wongbaker", name: "Wong-Baker FACES", fullName: "Wong-Baker FACES Pain Rating Scale", ageMin: 36, ageMax: 216, queixas: ["dor"], respondente: ["autoaplicavel"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "triagem", tempo: "1 min", description: "6 faces para autoavaliação de intensidade da dor (0–10).", appRoute: "/generic-scale/wongbaker"},
  { id: "flacc", name: "FLACC", fullName: "Face, Legs, Activity, Cry, Consolability", ageMin: 0, ageMax: 84, queixas: ["dor"], respondente: ["clinico"], respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "escala-registro", prioridade: "triagem", tempo: "2 min", description: "Avaliação comportamental de dor em crianças pré-verbais.", fonte: "Merkel SI et al., 1997 - University of Michigan", validacaoBrasil: "Sim", scoringCutoff: "0-3 nenhuma/dor mínima; 4-6 dor moderada; 7-10 dor severa", licencaUso: "livre", signalTags: ["dor", "expressão facial", "choro", "consolabilidade", "movimento das pernas"], appRoute: "/generic-scale/flacc"},
  { id: "pedmidas", name: "PedMIDAS", fullName: "Pediatric Migraine Disability Assessment", ageMin: 72, ageMax: 216, queixas: ["dor"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "5 min", description: "6 itens avaliando impacto funcional da enxaqueca nos últimos 3 meses.", appRoute: "/generic-scale/pedmidas", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},

  // ===== COGNIÇÃO =====
  { id: "wppsi", name: "WPPSI-IV", fullName: "Wechsler Preschool and Primary Scale of Intelligence IV", ageMin: 24, ageMax: 90, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "30–60 min", description: "Avaliação de inteligência para pré-escolares — QI verbal, execução e total.", appRoute: "/generic-scale/wppsi"},
  { id: "wisc5", name: "WISC-V", fullName: "Wechsler Intelligence Scale for Children V", ageMin: 72, ageMax: 204, queixas: ["cognicao", "aprendizagem"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "60–90 min", description: "Padrão-ouro para avaliação de inteligência em escolares. 5 índices fatoriais.", fonte: "Wechsler D, 2014", validacaoBrasil: "Sim", scoringCutoff: "QI <70 deficiência intelectual provável", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/wisc5"},
  { id: "leiter3", name: "Leiter-3", fullName: "Leiter International Performance Scale 3", ageMin: 36, ageMax: 216, queixas: ["cognicao", "tea"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "30–45 min", description: "Avaliação não-verbal de inteligência — útil em TEA e deficiência auditiva.", appRoute: "/generic-scale/leiter3"},
  { id: "raven", name: "Raven Colorido", fullName: "Matrizes Progressivas de Raven — Colorido", ageMin: 60, ageMax: 132, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "triagem", tempo: "15–25 min", description: "Raciocínio não-verbal por matrizes progressivas coloridas.", appRoute: "/generic-scale/raven"},
  { id: "nepsy2", name: "NEPSY-II", fullName: "Neuropsychological Assessment II", ageMin: 36, ageMax: 192, queixas: ["cognicao", "tdah"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "45–90 min", description: "Bateria neuropsicológica: atenção, linguagem, memória, sensório-motor, visuoespacial e social.", fonte: "Korkman M et al., 2007", validacaoBrasil: "Parcial", scoringCutoff: "scaled score <=6 baixo desempenho", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/nepsy2", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},

  // ===== APRENDIZAGEM =====
  { id: "tde", name: "TDE", fullName: "Teste de Desempenho Escolar", ageMin: 72, ageMax: 168, queixas: ["aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", description: "Avalia escrita, aritmética e leitura — padronizado para Brasil.", fonte: "Stein LM, 1994", validacaoBrasil: "Sim", scoringCutoff: "Escore bruto convertido a escore padrão; <80 abaixo do esperado; 80-119 adequado; >120 superior", licencaUso: "comercial", appRoute: "/generic-scale/tde", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  { id: "prolec", name: "PROLEC-SE", fullName: "Provas de Avaliação dos Processos de Leitura", ageMin: 72, ageMax: 144, queixas: ["aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–40 min", description: "Avalia processos léxicos, sintáticos e semânticos da leitura.", appRoute: "/generic-scale/prolec", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  { id: "confias", name: "CONFIAS", fullName: "Consciência Fonológica: Instrumento de Avaliação Sequencial", ageMin: 48, ageMax: 96, queixas: ["aprendizagem", "linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia consciência fonológica em nível de sílaba e fonema.", appRoute: "/generic-scale/confias", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo"},
  ...
  { id: "vineland", name: "Vineland-3", fullName: "Vineland Adaptive Behavior Scales 3", ageMin: 0, ageMax: 216, queixas: ["funcionalidade", "tea", "atraso"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "20–60 min", appRoute: "/vineland", implementationStatus: "metadata_only", description: "Comunicação, vida diária, socialização e motricidade.", fonte: "Sparrow SS et al., 2016", validacaoBrasil: "Parcial", scoringCutoff: "score adaptativo <70 significativo", licencaUso: "comercial", pendente_validacao_clinica: false, respondente_novo: "questionario-parental", tarefa_tipo: "entrevista-estruturada" },
  { id: "pedsql", name: "PedsQL", fullName: "Pediatric Quality of Life Inventory", ageMin: 24, ageMax: 216, queixas: ["funcionalidade"], respondente: ["pais", "autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", signalTags: ["qualidade de vida", "função física", "função emocional", "função social", "função escolar"], appRoute: "/pedsql", description: "Funcionamento físico, emocional, social e escolar.", fonte: "Varni JW et al., 2001", validacaoBrasil: "Sim", scoringCutoff: "0-100 (100=melhor QV); <60 impacto clínico significativo; >80 QV adequada", licencaUso: "comercial", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "pedicat", name: "PEDI-CAT", fullName: "Pediatric Evaluation of Disability Inventory - CAT", ageMin: 0, ageMax: 216, queixas: ["funcionalidade", "pc"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "15 min", description: "Avalia mobilidade, atividades diárias, social/cognitivo e responsabilidade.", fonte: "Haley SM et al., 2012", validacaoBrasil: "Sim", scoringCutoff: "normas padronizadas por idade", licencaUso: "comercial", pendente_validacao_clinica: false, appRoute: "/generic-scale/pedicat", respondente_novo: "questionario-parental", tarefa_tipo: "entrevista-estruturada"},
  { id: "weefim", name: "WeeFIM", fullName: "Functional Independence Measure for Children", ageMin: 6, ageMax: 96, queixas: ["funcionalidade", "pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "18 itens de independência funcional: autocuidado, mobilidade e cognição.", fonte: "Msall ME et al., 1994", pubmedId: "PMID 8014620", validacaoBrasil: "Sim", scoringCutoff: "maiores escores indicam maior independência", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/weefim", respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental"},

  // ===== NEONATAL =====
  { id: "napi", name: "NAPI", fullName: "Neurobehavioral Assessment of Preterm Infant", ageMin: 0, ageMax: 4, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia estado comportamental, tônus motor e orientação em RNPT.", appRoute: "/generic-scale/napi", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "nnns", name: "NNNS", fullName: "NICU Network Neurobehavioral Scale", ageMin: 0, ageMax: 2, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", description: "115 itens avaliando neurointegridade, maturidade e estresse em RN de risco.", fonte: "Lester BM et al., 2004", pubmedId: "PMID 14993575", validacaoBrasil: "Parcial", scoringCutoff: "perfil neurocomportamental dimensional", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/nnns", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "observacao-comportamental"},
  { id: "nbas", name: "NBAS", fullName: "Neonatal Behavioral Assessment Scale (Brazelton)", ageMin: 0, ageMax: 2, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", description: "Avalia capacidades comportamentais e reflexos do neonato a termo.", fonte: "Brazelton TB, Nugent JK, 1995", validacaoBrasil: "Parcial", scoringCutoff: "interpretação dimensional", licencaUso: "restrita", pendente_validacao_clinica: false, appRoute: "/generic-scale/nbas", respondente_novo: "teste-direto-desempenho", tarefa_tipo: "observacao-comportamental"},

  // ===== RISCO SUICÍDIO =====
  { id: "cssrs", name: "C-SSRS", fullName: "Columbia Suicide Severity Rating Scale", ageMin: 72, ageMax: 216, queixas: ["suicidio", "depressao"], respondente: ["clinico"], prioridade: "triagem", tempo: "5–10 min", signalTags: ["ideação suicida", "plano", "intenção", "comportamento suicida", "autolesão"], appRoute: "/cssrs", description: "Escala Columbia — 6 níveis de gravidade de ideação suicida.", fonte: "Posner K et al., 2011", validacaoBrasil: "Sim", scoringCutoff: "Ideação: nível 1 desejo passivo; 2-3 ideação ativa; 4-5 plano/intenção suicida; Comportamento: qualquer resposta SIM requer intervenção", licencaUso: "livre", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada" },
  { id: "asq-suicide", name: "ASQ", fullName: "Ask Suicide-Screening Questions", ageMin: 120, ageMax: 216, queixas: ["suicidio"], respondente: ["clinico"], prioridade: "triagem", tempo: "2 min", description: "4 perguntas de triagem rápida de risco suicida em emergência.", signalTags: ["ideação suicida", "desejo de morte", "autolesão", "risco agudo"], appRoute: "/generic-scale/asq-suicide", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "siqjr", name: "SIQ-Jr", fullName: "Suicidal Ideation Questionnaire - Junior", ageMin: 84, ageMax: 168, queixas: ["suicidio"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "10 min", description: "15 itens de autoavaliação de ideação suicida em crianças e adolescentes.", appRoute: "/generic-scale/siqjr", respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado"},
  { id: "ecar-si", name: "ECAR-SI NEXUS", fullName: "Escala Clínica de Avaliação de Risco — Suicidalidade Infantojuvenil", ageMin: 96, ageMax: 216, queixas: ["suicidio"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/ecar-si", description: "36 itens, 9 blocos (8 risco + 1 proteção), alarmes clínicos e conduta.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },

  // ===== PSICOSE / MANIA =====
  { id: "ymrs", name: "YMRS", fullName: "Young Mania Rating Scale", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "11 itens avaliando gravidade de mania — humor, atividade, sono, fala, pensamento.", appRoute: "/generic-scale/ymrs", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada"},
  { id: "bprsc", name: "BPRS-C", fullName: "Brief Psychiatric Rating Scale for Children", ageMin: 60, ageMax: 216, queixas: ["psicose", "comportamento"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "21 itens de sintomas psiquiátricos: ansiedade, depressão, psicose, hostilidade.", appRoute: "/generic-scale/bprsc", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},
  { id: "panss-ped", name: "PANSS Pediátrico", fullName: "Positive and Negative Syndrome Scale — Pediátrico", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–40 min", description: "30 itens: sintomas positivos, negativos e psicopatologia geral.", appRoute: "/generic-scale/panss-ped", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada"},

  // ===== TIQUES =====
  { id: "ygtss", name: "YGTSS", fullName: "Yale Global Tic Severity Scale", ageMin: 36, ageMax: 216, queixas: ["tiques"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", signalTags: ["tiques motores", "tiques vocais", "frequência", "intensidade", "interferência"], appRoute: "/ygtss", description: "Tiques motores e vocais: número, frequência, intensidade, complexidade e interferência.", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada" },
  ...
  { id: "aims-efeitos", name: "AIMS-DT", fullName: "Abnormal Involuntary Movement Scale (AIMS)", ageMin: 0, ageMax: 216, queixas: ["efeitos"], respondente: ["clinico"], prioridade: "monitorizacao", tempo: "10 min", description: "12 itens avaliando movimentos involuntários — discinesia tardia.", fonte: "Guy W, 1976 (ECDEU Assessment Manual, NIMH — manual não indexado no PubMed); convenções de aplicação: Munetz MR, Benjamin S, 1988 — Hosp Community Psychiatry 39(11):1172-7. PMID 2906320 · doi:10.1176/ps.39.11.1172", appRoute: "/generic-scale/aims-efeitos", respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental"},
  { id: "bars", name: "BARS", fullName: "Barnes Akathisia Rating Scale", ageMin: 0, ageMax: 216, queixas: ["efeitos"], respondente: ["clinico"], prioridade: "monitorizacao", tempo: "5 min", description: "4 itens de avaliação global e objetiva de acatisia.", signalTags: ["acatisia", "inquietação", "movimento", "efeito colateral"], appRoute: "/generic-scale/bars", respondente_novo: "observacao-clinica-estruturada", tarefa_tipo: "observacao-comportamental"},
  { id: "uku", name: "UKU", fullName: "UKU Side Effect Rating Scale", ageMin: 0, ageMax: 216, queixas: ["efeitos"], respondente: ["clinico"], prioridade: "monitorizacao", tempo: "15 min", description: "48 itens de efeitos colaterais psiquiátricos, neurológicos, autonômicos e outros.", signalTags: ["efeitos colaterais", "sintomas psíquicos", "sintomas neurológicos", "autonômicos"], appRoute: "/generic-scale/uku", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado"},

  // ===== SUBSTÂNCIAS =====
  { id: "crafft", name: "CRAFFT", fullName: "Car, Relax, Alone, Forget, Friends, Trouble", ageMin: 144, ageMax: 216, queixas: ["comportamento", "substancias"], respondente: ["autoaplicavel"], respondente_novo: "autorrelato", tarefa_tipo: "questionario-fechado", prioridade: "triagem", tempo: "5 min", signalTags: ["uso de álcool", "uso de substâncias", "risco no trânsito", "comportamento de risco"], appRoute: "/crafft", description: "Screening de uso de álcool e drogas para adolescentes." },

  // ===== PANT E BATERIAS DR. JADSON =====
  { id: "pant", name: "PANT", fullName: "Protocolo de Avaliação do Neurodesenvolvimento Típico — 100 Escalas", ageMin: 0, ageMax: 216, queixas: ["atraso", "funcionalidade", "tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–60 min", appRoute: "/pant", description: "100 escalas passivas em 5 macrodomínios: comunicação, linguagem, executiva, sensorial, emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "emdi", name: "EMDI", fullName: "Escala Médica do Desenvolvimento Infantil", ageMin: 12, ageMax: 72, queixas: ["atraso"], respondente: ["clinico"], prioridade: "triagem", tempo: "10 min", signalTags: ["marcos motores", "desenvolvimento infantil", "coordenação", "postura"], appRoute: "/emdi", description: "Triagem estruturada do desenvolvimento infantil — Bateria Dr. Jadson.", respondente_novo: "questionario-profissional", tarefa_tipo: "entrevista-estruturada" },
  { id: "eaf", name: "EAF", fullName: "Escala de Adaptação Funcional", ageMin: 24, ageMax: 216, queixas: ["funcionalidade"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/eaf", description: "Adaptação funcional em contextos diários — Bateria Dr. Jadson.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "pdae", name: "PDAE", fullName: "Protocolo de Desempenho Acadêmico e Escolar", ageMin: 72, ageMax: 216, queixas: ["aprendizagem"], respondente: ["professor", "pais"], prioridade: "triagem", tempo: "10 min", appRoute: "/pdae", description: "Desempenho acadêmico e escolar — Bateria Dr. Jadson.", implementationStatus: "complete", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "ecsm", name: "ECSM", fullName: "Escala de Cognição Social e Mentalização", ageMin: 48, ageMax: 216, queixas: ["tea", "cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/ecsm", description: "Cognição social e metacognição — Bateria Dr. Jadson.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "ips", name: "IPS", fullName: "Inventário de Processamento Sensorial", ageMin: 24, ageMax: 144, queixas: ["tea", "atraso"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", appRoute: "/ips", description: "Processamento sensorial — Bateria Dr. Jadson.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  ...
  { id: "edi", name: "EDI-NEXUS", fullName: "Escala de Depressão Infantil — Bateria Dr. Jadson", ageMin: 48, ageMax: 216, queixas: ["depressao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/edi", description: "24 itens de depressão infantil — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "eai", name: "EAI-NEXUS", fullName: "Escala de Ansiedade Infantil — Bateria Dr. Jadson", ageMin: 48, ageMax: 216, queixas: ["ansiedade"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/eai", description: "20 itens de ansiedade infantil — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "easi", name: "EASI-NEXUS", fullName: "Escala de Ansiedade Social Infantil — Bateria Dr. Jadson", ageMin: 48, ageMax: 216, queixas: ["ansiedade"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/easi", description: "15 itens de ansiedade social infantil — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "ems", name: "EMS-NEXUS", fullName: "Escala de Mutismo Seletivo — Bateria Dr. Jadson", ageMin: 24, ageMax: 144, queixas: ["ansiedade", "linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/ems", description: "15 itens de mutismo seletivo — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "etare", name: "ETARE-NEXUS", fullName: "Escala de Transtorno Alimentar Restritivo Evitativo — Bateria Dr. Jadson", ageMin: 24, ageMax: 216, queixas: ["alimentacao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/etare", description: "18 itens de TARE — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  { id: "eaah", name: "EAAH-NEXUS", fullName: "Escala de Autoagressividade e Heteroagressividade — Bateria Dr. Jadson", ageMin: 36, ageMax: 216, queixas: ["comportamento", "suicidio"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/eaah", description: "20 itens de agressividade — Bateria de Regulação Emocional.", respondente_novo: "questionario-parental", tarefa_tipo: "questionario-fechado" },
  ...
  { id: "kabc2", name: "K-ABC-II", fullName: "Kaufman Assessment Battery for Children II", ageMin: 36, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "30–70 min", description: "Bateria cognitiva com dois modelos interpretativos (Luria e CHC). Avalia processamento sequencial, simultâneo, aprendizagem e planejamento.", appRoute: "/generic-scale/kabc2"},
  { id: "wcst", name: "WCST", fullName: "Wisconsin Card Sorting Test", ageMin: 72, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "20–30 min", description: "Avalia flexibilidade cognitiva, formação de conceitos e função do lóbulo frontal por classificação de cartões.", appRoute: "/generic-scale/wcst"},
  { id: "tmt", name: "Trail Making A e B", fullName: "Trail Making Test A e B", ageMin: 108, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "5–10 min", description: "Avalia velocidade de processamento, atenção e flexibilidade cognitiva. Parte A: sequenciamento; parte B: alternância.", appRoute: "/generic-scale/tmt"},
  { id: "stroop", name: "Stroop", fullName: "Stroop Color and Word Test", ageMin: 84, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "5 min", description: "Avalia inibição de resposta, atenção seletiva e velocidade de processamento pelo efeito de interferência cor-palavra.", appRoute: "/generic-scale/stroop"},
  ...
  { id: "fas-fluencia", name: "FAS Fluência Verbal", fullName: "Teste de Fluência Verbal FAS", ageMin: 72, ageMax: 216, queixas: ["cognicao", "linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Avalia fluência verbal fonológica (letras F, A, S) e semântica. Sensivel a disfunções frontais e de linguagem.", signalTags: ["fluência verbal", "funções executivas", "evocação", "linguagem"], appRoute: "/generic-scale/fas-fluencia"},
  ...
  { id: "d2", name: "d2 Cancelamento", fullName: "Teste de Cancelamento d2", ageMin: 108, ageMax: 216, queixas: ["cognicao", "tdah"], respondente: ["clinico"], respondente_novo: "teste-direto-desempenho", tarefa_tipo: "tarefa-desempenho-cognitivo", prioridade: "diagnostica", tempo: "8 min", description: "Avalia atenção concentrada, velocidade de processamento e controle inibitório por tarefa de cancelamento de símbolos.", appRoute: "/generic-scale/d2"},
  ...
  { id: "engel", name: "Engel Classification", fullName: "Engel Seizure Outcome Scale", ageMin: 0, ageMax: 216, queixas: ["epilepsia"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Classifica desfecho de crises após cirurgia de epilepsia em 4 classes (I: livre de crises; IV: sem melhora).", signalTags: ["controle de crises", "desfecho cirúrgico", "frequência de crises"], appRoute: "/generic-scale/engel"},
  ...
  { id: "ballard", name: "Ballard", fullName: "New Ballard Score", ageMin: 0, ageMax: 2, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Avalia maturidade neuromuscular e física do recém-nascido para estimar idade gestacional ao nascimento.", appRoute: "/ballard"},
  { id: "apgar", name: "APGAR", fullName: "APGAR Score", ageMin: 0, ageMax: 1, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "triagem", tempo: "1 min", description: "Avalia vitalidade do recém-nascido no 1º e 5º minuto de vida: aparência, pulso, grimacea, atividade e respiração.", appRoute: "/generic-scale/apgar"},
  ...
  { id: "pipp", name: "PIPP", fullName: "Premature Infant Pain Profile", ageMin: 0, ageMax: 3, queixas: ["dor", "neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "2 min", description: "Perfil de dor aguda do prematuro/RN a termo — 7 indicadores (idade gestacional, estado comportamental, aumento da FC, queda da SatO2, testa franzida, olhos espremidos, sulco nasolabial), cada 0–3. Total 0–21: ≤6 dor mínima/ausente; 7–12 leve a moderada; >12 moderada a grave. Observar 15s antes e 30s durante o procedimento doloroso.", fonte: "Stevens B et al., Clin J Pain 1996; PIPP-R 2014", licencaUso: "livre", scoringCutoff: "≤6 mínima · 7–12 leve-moderada · >12 moderada-grave", appRoute: "/generic-scale/pipp"},
  { id: "cheops", name: "CHEOPS", fullName: "Children's Hospital of Eastern Ontario Pain Scale", ageMin: 12, ageMax: 84, queixas: ["dor"], respondente: ["clinico"], prioridade: "triagem", tempo: "2 min", description: "Escala observacional de dor pós-operatória (1–7 anos) — 6 categorias comportamentais (choro, face, verbal, tronco, toque, pernas). Total 4–13; ≥8 indica dor significativa que requer analgesia. Validada para dor aguda pós-operatória.", fonte: "McGrath PJ et al., 1985", licencaUso: "livre", scoringCutoff: "≥8 = dor significativa (analgesia)", appRoute: "/generic-scale/cheops"},
  { id: "rflacc", name: "r-FLACC", fullName: "Revised FLACC Scale", ageMin: 48, ageMax: 216, queixas: ["dor", "pc"], respondente: ["clinico"], prioridade: "triagem", tempo: "2 min", description: "Versão revisada do FLACC para crianças com deficiência intelectual ou incapacidades comunicativas.", signalTags: ["dor", "expressão facial", "consolabilidade", "comportamento", "deficiência"], appRoute: "/generic-scale/rflacc"},
  ...
  { id: "ess-adol", name: "ESS Adolescente", fullName: "Epworth Sleepiness Scale — Versão Adolescente Modificada", ageMin: 144, ageMax: 216, queixas: ["sono"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "5 min", description: "8 situações cotidianas para medir sonolência diurna excessiva em adolescentes.", signalTags: ["sonolência diurna", "cochilos", "adormecer", "alerta"], appRoute: "/generic-scale/ess-adol"},
  ...
  { id: "oci-cv", name: "OCI-CV", fullName: "Obsessive Compulsive Inventory — Child Version", ageMin: 84, ageMax: 204, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", description: "21 itens de triagem de sintomas obsessivo-compulsivos em crianças e adolescentes. Versão pediátrica do OCI.", signalTags: ["obsessões", "compulsões", "lavagem", "verificação", "ordem", "contagem"], appRoute: "/generic-scale/oci-cv"},
  { id: "docs", name: "DOCS", fullName: "Dimensional Obsessive-Compulsive Scale", ageMin: 144, ageMax: 216, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "20 itens avaliando 4 dimensões de TOC: contaminãção, responsabilidade/dano, inaceitável/intrusivo e simetria.", signalTags: ["contaminação", "responsabilidade", "simetria", "pensamentos inaceitáveis"], appRoute: "/generic-scale/docs"},
  { id: "cybocs-sr", name: "CY-BOCS-SR", fullName: "Children’s Yale-Brown OCS — Self-Report", ageMin: 96, ageMax: 204, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "Versão de autoavaliacão do CY-BOCS para monitorização de sintomas em crianças a partir de 8 anos.", signalTags: ["obsessões", "compulsões", "rituais", "tempo gasto em rituais", "interferência funcional"], appRoute: "/generic-scale/cybocs-sr"},
  ...
  // ===== TRAUMA / TEPT =====
  { id: "cpss-v", name: "CPSS-V", fullName: "Child PTSD Symptom Scale for DSM-5", ageMin: 96, ageMax: 216, queixas: ["trauma"], respondente: ["autoaplicavel", "crianca"], prioridade: "diagnostica", tempo: "15 min", description: "20 itens alinhados ao DSM-5 para diagnóstico e monitorização de TEPT em crianças e adolescentes.", signalTags: ["ptsd", "pesadelos", "evitação", "hipervigilância", "revivência"], appRoute: "/generic-scale/cpss-v"},
  ...
  { id: "cries13", name: "CRIES-13", fullName: "Children’s Revised Impact of Event Scale 13", ageMin: 96, ageMax: 216, queixas: ["trauma"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "5 min", description: "13 itens avaliando intrusão, evitação e exitação após eventos traumáticos em crianças.", signalTags: ["impacto do evento", "intrusão", "evitação", "excitação"], appRoute: "/generic-scale/cries13"},
...
const allScalesBase: ScaleEntry[] = [
  ...
  // Compêndio de Escalas de Neuropsiquiatria Infantojuvenil (DOCX, 2026-07):
