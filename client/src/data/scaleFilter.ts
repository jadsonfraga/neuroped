...
export const scales: ScaleEntry[] = [
  ...
  { id: "portage", name: "Portage", fullName: "Guia Portage de Educação Pré-Escolar / Inventário Operacionalizado (IPO)", ageMin: 0, ageMax: 72, queixas: ["atraso", "funcionalidade"], respondente: ["clinico"], prioridade: "triagem", tempo: "variável", description: "Inventário de habilidades do desenvolvimento (socialização, linguagem, autocuidado, cognição e motor) usado para planejar estimulação precoce de 0 a 6 anos.", fonte: "Bluma S et al., 1976; versão operacionalizada BR: Williams LCA & Aiello ALR", validacaoBrasil: "Sim (Inventário Portage Operacionalizado)", licencaUso: "comercial", signalTags: ["marcos do desenvolvimento", "estimulação precoce", "atraso", "funcionalidade"], appRoute: "/portage" },
