...
export const scales: ScaleEntry[] = [
  ...
  { id: "sdq", name: "SDQ", fullName: "Strengths and Difficulties Questionnaire", ageMin: 24, ageMax: 204, queixas: ["comportamento", "tdah", "ansiedade"], respondente: ["pais", "professor", "crianca"], prioridade: "triagem", tempo: "5–10 min", appRoute: "/sdq", description: "Comportamento pró-social, hiperatividade, emoções, conduta e pares.", fonte: "Goodman R, 1997", pubmedId: "PMID 9255702", validacaoBrasil: "Sim - Fleitlich-Bilyk B et al.", scoringCutoff: "score total >=17 alterado", licencaUso: "livre", pendente_validacao_clinica: false },
