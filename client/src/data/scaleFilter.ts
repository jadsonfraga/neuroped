...
export const scales: ScaleEntry[] = [
  ...
  { id: "conners-pais", name: "Conners 3 (Versão Pais)", fullName: "Conners Rating Scales 3 - Parent", ageMin: 72, ageMax: 216, queixas: ["tdah", "comportamento"], respondente: ["pais"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/conners-pais", description: "Avaliação parental de TDAH, problemas de conduta, aprendizagem e impulsividade.", fonte: "Conners CK, 2008 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 clinicamente relevante", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "conners-professor", name: "Conners 3 (Versão Professor)", fullName: "Conners Rating Scales 3 - Teacher", ageMin: 72, ageMax: 216, queixas: ["tdah", "comportamento"], respondente: ["professor"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/conners-professor", description: "Avaliação por professor de TDAH, problemas de conduta, aprendizagem e desempenho escolar.", fonte: "Conners CK, 2008 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 clinicamente relevante", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "conners-adolescente", name: "Conners 3 (Versão Adolescente)", fullName: "Conners Rating Scales 3 - Self-Report", ageMin: 108, ageMax: 216, queixas: ["tdah", "comportamento"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/conners-adolescente", description: "Autorrelato do adolescente sobre sintomas de TDAH e comportamento.", fonte: "Conners CK, 2008 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 clinicamente relevante", licencaUso: "comercial", pendente_validacao_clinica: false },
  ...
  { id: "sdq-pais", name: "SDQ (Versão Pais)", fullName: "Strengths and Difficulties Questionnaire - Parent", ageMin: 24, ageMax: 204, queixas: ["comportamento", "tdah", "ansiedade"], respondente: ["pais"], prioridade: "triagem", tempo: "5–10 min", appRoute: "/sdq-pais", description: "25 itens respondidos por pais sobre comportamento, dificuldades e habilidades sociais.", fonte: "Goodman R, 1997 - Cambridge University", pubmedId: "PMID 9255702", validacaoBrasil: "Sim - Fleitlich-Bilyk B et al.", scoringCutoff: "score total >=17 alterado", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "sdq-professor", name: "SDQ (Versão Professor)", fullName: "Strengths and Difficulties Questionnaire - Teacher", ageMin: 48, ageMax: 204, queixas: ["comportamento", "tdah", "ansiedade"], respondente: ["professor"], prioridade: "triagem", tempo: "5–10 min", appRoute: "/sdq-professor", description: "25 itens respondidos por professor sobre comportamento na escola e relacionamento com pares.", fonte: "Goodman R, 1997 - Cambridge University", pubmedId: "PMID 9255702", validacaoBrasil: "Sim - Fleitlich-Bilyk B et al.", scoringCutoff: "score total >=17 alterado", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "sdq-crianca", name: "SDQ (Versão Criança/Adolescente)", fullName: "Strengths and Difficulties Questionnaire - Self-Report", ageMin: 96, ageMax: 204, queixas: ["comportamento", "tdah", "ansiedade"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "5–10 min", appRoute: "/sdq-crianca", description: "Autorrelato de criança/adolescente sobre seu comportamento, dificuldades e habilidades.", fonte: "Goodman R, 1997 - Cambridge University", pubmedId: "PMID 9255702", validacaoBrasil: "Sim - Fleitlich-Bilyk B et al.", scoringCutoff: "score total >=17 alterado", licencaUso: "livre", pendente_validacao_clinica: false },
  ...
  // ===== ANSIEDADE =====
  { id: "scared-pais", name: "SCARED (Versão Pais)", fullName: "Screen for Child Anxiety Related Disorders - Parent Version", ageMin: 96, ageMax: 216, queixas: ["ansiedade"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", appRoute: "/scared-pais", description: "41 itens respondidos por pais sobre sintomas de ansiedade da criança.", fonte: "Birmaher B et al., 1997 - University of Pittsburgh", pubmedId: "PMID 9136490", validacaoBrasil: "Sim", scoringCutoff: ">=25 sugere transtorno ansioso", licencaUso: "livre", pendente_validacao_clinica: false },
  { id: "scared-crianca", name: "SCARED (Versão Criança/Adolescente)", fullName: "Screen for Child Anxiety Related Disorders - Child Version", ageMin: 120, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", appRoute: "/scared-crianca", description: "41 itens respondidos pela própria criança/adolescente sobre seus sintomas de ansiedade.", fonte: "Birmaher B et al., 1997 - University of Pittsburgh", pubmedId: "PMID 9136490", validacaoBrasil: "Sim", scoringCutoff: ">=25 sugere transtorno ansioso", licencaUso: "livre", pendente_validacao_clinica: false },
  ...
  { id: "rcads-pais", name: "RCADS (Versão Pais)", fullName: "Revised Children's Anxiety and Depression Scale - Parent Version", ageMin: 96, ageMax: 216, queixas: ["ansiedade", "depressao"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", appRoute: "/rcads-pais", description: "47 itens respondidos por pais sobre ansiedade e depressão da criança (6 subescalas baseadas no DSM).", fonte: "Chorpita BF et al., 2000 - Journal of the American Academy of Child & Adolescent Psychiatry", validacaoBrasil: "Parcial", scoringCutoff: "Total ≥63 provável transtorno; subescalas interpretadas conforme T-score", licencaUso: "livre" },
  { id: "rcads-crianca", name: "RCADS (Versão Criança/Adolescente)", fullName: "Revised Children's Anxiety and Depression Scale - Child Version", ageMin: 120, ageMax: 216, queixas: ["ansiedade", "depressao"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", appRoute: "/rcads-crianca", description: "47 itens de autorrelato sobre ansiedade e depressão pessoal (6 subescalas baseadas no DSM).", fonte: "Chorpita BF et al., 2000 - Journal of the American Academy of Child & Adolescent Psychiatry", validacaoBrasil: "Parcial", scoringCutoff: "Total ≥63 provável transtorno; subescalas interpretadas conforme T-score", licencaUso: "livre" },
