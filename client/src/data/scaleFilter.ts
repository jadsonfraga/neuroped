...
export interface ScaleEntry {
  ...
  // Novos campos clínicos — PROBLEMA 6 (comunicação, alfabetização, tipo de avaliação)
  verbal?: boolean;     // true = requer/usa linguagem falada | false = não-verbal | undefined = ambos
  alphabetic?: boolean; // true = requer leitura/escrita | false = pré-alfabética | undefined = ambos
  assessment_type?: "diagnostic" | "monitoring" | "both"; // tipo de avaliação esperada
}
...
export const queixas: QueixaCategory[] = [
  ...
  { id: "substancias", label: "Uso de Substâncias / Abuso", icon: "droplet", color: "from-red-500 to-orange-600", bgLight: "bg-red-50 dark:bg-red-950/30", iconColor: "text-red-600 dark:text-red-400" },
];
...
export const scales: ScaleEntry[] = [
  ...
  { id: "denver", name: "Denver II", fullName: "Denver Developmental Screening Test II", ageMin: 0, ageMax: 72, queixas: ["atraso", "funcionalidade"], respondente: ["clinico"], prioridade: "triagem", tempo: "15–20 min", appRoute: "/denver", description: "Avalia marcos motores, linguagem, pessoal-social e motor fino-adaptativo.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "bayley", name: "Bayley-III", fullName: "Bayley Scales of Infant Development III", ageMin: 1, ageMax: 42, queixas: ["atraso", "neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–90 min", description: "Padrão-ouro para avaliação cognitiva, motora e de linguagem em lactentes.", fonte: "Bayley N, 2019 (Bayley-4)", validacaoBrasil: "Parcial", scoringCutoff: "composite score <85 abaixo do esperado", licencaUso: "comercial", pendente_validacao_clinica: false, verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "griffiths", name: "Griffiths III", fullName: "Griffiths Scales of Child Development III", ageMin: 0, ageMax: 72, queixas: ["atraso"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "40–60 min", description: "Avalia 5 áreas: fundamentos da aprendizagem, linguagem, olho-mão, pessoal-social-emocional e motricidade grossa.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "asq3", name: "ASQ-3", fullName: "Ages & Stages Questionnaire 3", ageMin: 1, ageMax: 66, queixas: ["atraso"], respondente: ["pais"], prioridade: "triagem", tempo: "10–15 min", appRoute: "/asq3", description: "Triagem do desenvolvimento em 5 domínios com questionário para pais.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "peds", name: "PEDS", fullName: "Parents' Evaluation of Developmental Status", ageMin: 0, ageMax: 96, queixas: ["atraso"], respondente: ["pais"], prioridade: "triagem", tempo: "5 min", description: "10 perguntas de triagem respondidas pelos pais sobre preocupações com o desenvolvimento.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "ados2", name: "ADOS-2", fullName: "Autism Diagnostic Observation Schedule 2", ageMin: 12, ageMax: 216, queixas: ["tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "40–60 min", description: "Padrão-ouro observacional para diagnóstico de TEA. 5 módulos por nível de linguagem.", fonte: "Lord C et al., 2012", validacaoBrasil: "Parcial - uso clínico e estudos brasileiros", scoringCutoff: "algoritmos por módulo", licencaUso: "restrita", pendente_validacao_clinica: false, verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "atec", name: "ATEC", fullName: "Autism Treatment Evaluation Checklist", ageMin: 24, ageMax: 216, queixas: ["tea"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "10 min", description: "Monitoriza resposta ao tratamento em TEA. 77 itens em 4 subescalas." },  { id: "tea-checklists", name: "Checklists TEA", fullName: "ADOS-2, ADI-R, CARS-2, GARS-3, SRS-2 — Resumo Clínico", ageMin: 12, ageMax: 216, queixas: ["tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "Variável", appRoute: "/tea", description: "Checklists clínicos adaptados dos 5 principais instrumentos de TEA." },
  ...
  // ===== TDAH =====  { id: "barkley", name: "Barkley", fullName: "Barkley Functional Impairment Scale - Children", ageMin: 72, ageMax: 216, queixas: ["tdah"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "10 min", description: "Avalia prejuízo funcional associado ao TDAH em múltiplos contextos." },
  ...
  // ===== ANSIEDADE =====
  { id: "scared", name: "SCARED", fullName: "Screen for Child Anxiety Related Disorders", ageMin: 96, ageMax: 216, queixas: ["ansiedade"], respondente: ["pais", "crianca"], prioridade: "triagem", tempo: "10 min", appRoute: "/scared", description: "Pânico, ansiedade generalizada, separação, fobia social e evitação escolar.", fonte: "Birmaher B et al., 1997", pubmedId: "PMID 9136490", validacaoBrasil: "Sim", scoringCutoff: ">=25 sugere transtorno ansioso", licencaUso: "livre", pendente_validacao_clinica: false, verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "masc2", name: "MASC-2", fullName: "Multidimensional Anxiety Scale for Children 2", ageMin: 96, ageMax: 216, queixas: ["ansiedade"], respondente: ["crianca", "pais"], prioridade: "diagnostica", tempo: "15 min", description: "50 itens em 4 escalas: ansiedade física, evitação de dano, ansiedade social e separação/pânico.", fonte: "March JS, 2013", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65", licencaUso: "comercial", pendente_validacao_clinica: false },
  { id: "rcads", name: "RCADS", fullName: "Revised Children's Anxiety and Depression Scale", ageMin: 96, ageMax: 216, queixas: ["ansiedade", "depressao"], respondente: ["autoaplicavel", "pais"], prioridade: "triagem", tempo: "10 min", description: "47 itens cobrindo 6 subescalas baseadas no DSM (ansiedade e depressão).", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "scas", name: "SCAS", fullName: "Spence Children's Anxiety Scale", ageMin: 36, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel", "pais"], prioridade: "triagem", tempo: "10 min", description: "Avalia 6 domínios de ansiedade: separação, social, obsessões, pânico, generalizada, medo de lesão.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "staic", name: "STAIC", fullName: "State-Trait Anxiety Inventory for Children", ageMin: 72, ageMax: 168, queixas: ["ansiedade"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "10 min", description: "Diferencia ansiedade-estado (transitória) de ansiedade-traço (tendência estável).", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "gad7ped", name: "GAD-7 Pediátrico", fullName: "Generalized Anxiety Disorder 7 — Versão Pediátrica", ageMin: 144, ageMax: 216, queixas: ["ansiedade"], respondente: ["crianca"], prioridade: "triagem", tempo: "3 min", description: "7 itens de triagem rápida para ansiedade generalizada.", fonte: "Spitzer RL et al., 2006", pubmedId: "PMID 16717171", validacaoBrasil: "Sim", scoringCutoff: ">=10 ansiedade moderada", licencaUso: "livre", pendente_validacao_clinica: false },

  // ===== DEPRESSÃO =====
  { id: "cdi2", name: "CDI-2", fullName: "Children's Depression Inventory 2", ageMin: 84, ageMax: 204, queixas: ["depressao"], respondente: ["crianca"], prioridade: "triagem", tempo: "10–15 min", appRoute: "/cdi2", description: "Inventário de Depressão Infantil — 28 itens.", fonte: "Kovacs M, 2011", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65", licencaUso: "comercial", pendente_validacao_clinica: false, verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "phqa", name: "PHQ-A", fullName: "Patient Health Questionnaire - Adolescentes", ageMin: 132, ageMax: 216, queixas: ["depressao"], respondente: ["crianca"], prioridade: "triagem", tempo: "5 min", appRoute: "/phqa", description: "9 itens para triagem de depressão em adolescentes.", fonte: "Johnson JG et al., 2002", pubmedId: "PMID 12090817", validacaoBrasil: "Parcial", scoringCutoff: ">=10 depressao moderada", licencaUso: "livre", pendente_validacao_clinica: false, verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "mfq", name: "MFQ", fullName: "Mood and Feelings Questionnaire", ageMin: 72, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel", "pais"], prioridade: "triagem", tempo: "10 min", description: "33 itens avaliando humor depressivo nas últimas 2 semanas.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "cdrsr", name: "CDRS-R", fullName: "Children's Depression Rating Scale - Revised", ageMin: 72, ageMax: 144, queixas: ["depressao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "17 itens aplicados pelo clínico. Padrão-ouro para gravidade de depressão infantil.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "rads2", name: "RADS-2", fullName: "Reynolds Adolescent Depression Scale 2", ageMin: 132, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "10 min", description: "30 itens de autoaplicação para depressão na adolescência.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  ...
  { id: "gmfcs", name: "GMFCS", fullName: "Gross Motor Function Classification System", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", appRoute: "/gmfcs", description: "Classificação da função motora grossa em PC — 5 níveis.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "gmfm", name: "GMFM-88/66", fullName: "Gross Motor Function Measure", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "45–60 min", description: "88 itens em 5 dimensões motoras. Padrão-ouro para medir função motora na PC.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "macs", name: "MACS", fullName: "Manual Ability Classification System", ageMin: 48, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Classifica habilidade manual na PC em 5 níveis.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "cfcs", name: "CFCS", fullName: "Communication Function Classification System", ageMin: 24, ageMax: 216, queixas: ["pc", "linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Classifica a eficácia da comunicação na PC em 5 níveis.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "edacs", name: "EDACS", fullName: "Eating and Drinking Ability Classification System", ageMin: 36, ageMax: 216, queixas: ["pc", "alimentacao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Classifica habilidade alimentar na PC em 5 níveis.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "ashworth", name: "Ashworth Modificada", fullName: "Escala de Ashworth Modificada", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "monitorizacao", tempo: "5–10 min", description: "Avalia espasticidade muscular em escala 0–4.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  ...
  { id: "reel3", name: "REEL-3", fullName: "Receptive-Expressive Emergent Language Test 3", ageMin: 0, ageMax: 36, queixas: ["linguagem", "atraso"], respondente: ["clinico", "pais"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia linguagem receptiva e expressiva emergente de 0 a 3 anos.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "celf5", name: "CELF-5", fullName: "Clinical Evaluation of Language Fundamentals 5", ageMin: 60, ageMax: 216, queixas: ["linguagem", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–60 min", description: "Avaliação abrangente de linguagem receptiva e expressiva.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "ppvt4", name: "PPVT-4", fullName: "Peabody Picture Vocabulary Test 4", ageMin: 30, ageMax: 216, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15 min", description: "Vocabulário receptivo por identificação de figuras.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },

  // ===== SONO =====
  { id: "cshq", name: "CSHQ", fullName: "Children's Sleep Habits Questionnaire", ageMin: 48, ageMax: 120, queixas: ["sono"], respondente: ["pais"], prioridade: "triagem", tempo: "10–15 min", appRoute: "/cshq", description: "Hábitos de sono infantil — 7 domínios de distúrbio.", fonte: "Owens JA et al., 2000", pubmedId: "PMID 11174669", validacaoBrasil: "Sim", scoringCutoff: ">41 distúrbio do sono provável", licencaUso: "restrita", pendente_validacao_clinica: false, verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "bisq", name: "BISQ", fullName: "Brief Infant Sleep Questionnaire", ageMin: 0, ageMax: 36, queixas: ["sono"], respondente: ["pais"], prioridade: "triagem", tempo: "5 min", description: "Triagem breve de padrões de sono em lactentes.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "bears", name: "BEARS", fullName: "Bedtime, Excessive Daytime Sleepiness, Awakenings, Regularity, Snoring", ageMin: 24, ageMax: 216, queixas: ["sono"], respondente: ["pais", "crianca"], prioridade: "triagem", tempo: "5 min", description: "5 perguntas-chave para triagem de distúrbios do sono.", fonte: "Owens JA, Dalzell V, 2005", pubmedId: "PMID 15764706", validacaoBrasil: "Parcial", scoringCutoff: "triagem qualitativa sem cutoff único", licencaUso: "livre", pendente_validacao_clinica: false },
  ...
  { id: "psq", name: "PSQ", fullName: "Pediatric Sleep Questionnaire", ageMin: 24, ageMax: 216, queixas: ["sono"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", description: "Triagem de distúrbios respiratórios do sono e sonolência.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },

  // ===== ALIMENTAÇÃO =====
  { id: "soma", name: "SOMA", fullName: "Schedule for Oral Motor Assessment", ageMin: 8, ageMax: 24, queixas: ["alimentacao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avaliação padronizada da função motora oral durante alimentação.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "eda", name: "EDA", fullName: "Escala de Dificuldade Alimentar", ageMin: 6, ageMax: 72, queixas: ["alimentacao"], respondente: ["pais"], prioridade: "triagem", tempo: "10 min", description: "Triagem de dificuldades alimentares na primeira infância.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },

  // ===== DOR / CEFALEIA =====
  { id: "cefaleia-calendario", name: "Calendário de Cefaleia", fullName: "Calendário de Cefaleia — Registro Diário", ageMin: 36, ageMax: 216, queixas: ["dor"], respondente: ["pais", "autoaplicavel"], prioridade: "monitorizacao", tempo: "5 min/registro", appRoute: "/cefaleia", description: "Intensidade, tipo, localização, aura, triggers e resposta medicamentosa.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "wongbaker", name: "Wong-Baker FACES", fullName: "Wong-Baker FACES Pain Rating Scale", ageMin: 36, ageMax: 216, queixas: ["dor"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "1 min", description: "6 faces para autoavaliação de intensidade da dor (0–10).", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  { id: "flacc", name: "FLACC", fullName: "Face, Legs, Activity, Cry, Consolability", ageMin: 0, ageMax: 84, queixas: ["dor"], respondente: ["clinico"], prioridade: "triagem", tempo: "2 min", description: "Avaliação comportamental de dor em crianças pré-verbais.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "pedmidas", name: "PedMIDAS", fullName: "Pediatric Migraine Disability Assessment", ageMin: 72, ageMax: 216, queixas: ["dor"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "5 min", description: "6 itens avaliando impacto funcional da enxaqueca nos últimos 3 meses.", verbal: true, alphabetic: true, assessment_type: "monitoring" },

  // ===== COGNIÇÃO =====
  { id: "wppsi", name: "WPPSI-IV", fullName: "Wechsler Preschool and Primary Scale of Intelligence IV", ageMin: 24, ageMax: 90, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–60 min", description: "Avaliação de inteligência para pré-escolares — QI verbal, execução e total.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "leiter3", name: "Leiter-3", fullName: "Leiter International Performance Scale 3", ageMin: 36, ageMax: 216, queixas: ["cognicao", "tea"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–45 min", description: "Avaliação não-verbal de inteligência — útil em TEA e deficiência auditiva.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "raven", name: "Raven Colorido", fullName: "Matrizes Progressivas de Raven — Colorido", ageMin: 60, ageMax: 132, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "triagem", tempo: "15–25 min", description: "Raciocínio não-verbal por matrizes progressivas coloridas.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  // ===== APRENDIZAGEM =====
  { id: "tde", name: "TDE", fullName: "Teste de Desempenho Escolar", ageMin: 72, ageMax: 168, queixas: ["aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", description: "Avalia escrita, aritmética e leitura — padronizado para Brasil.", verbal: false, alphabetic: true, assessment_type: "diagnostic" },
  { id: "prolec", name: "PROLEC-SE", fullName: "Provas de Avaliação dos Processos de Leitura", ageMin: 72, ageMax: 144, queixas: ["aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–40 min", description: "Avalia processos léxicos, sintáticos e semânticos da leitura.", verbal: false, alphabetic: true, assessment_type: "diagnostic" },
  { id: "confias", name: "CONFIAS", fullName: "Consciência Fonológica: Instrumento de Avaliação Sequencial", ageMin: 48, ageMax: 96, queixas: ["aprendizagem", "linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia consciência fonológica em nível de sílaba e fonema.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  ...
  // ===== NEONATAL =====
  { id: "napi", name: "NAPI", fullName: "Neurobehavioral Assessment of Preterm Infant", ageMin: 0, ageMax: 4, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20 min", description: "Avalia estado comportamental, tônus motor e orientação em RNPT.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "eaf", name: "EAF", fullName: "Escala de Adaptação Funcional", ageMin: 24, ageMax: 216, queixas: ["funcionalidade"], respondente: ["pais", "clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/eaf", description: "Adaptação funcional em contextos diários — Bateria Dr. Jadson." },  { id: "ecsm", name: "ECSM", fullName: "Escala de Cognição Social e Mentalização", ageMin: 48, ageMax: 216, queixas: ["tea", "cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", appRoute: "/ecsm", description: "Cognição social e metacognição — Bateria Dr. Jadson." },
  ...
  { id: "leiter3-ext", name: "Leiter-3", fullName: "Leiter International Performance Scale 3", ageMin: 36, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30 min", description: "Avaliação não-verbal de inteligência e memória. Indicada para crianças com barreira de linguagem, surdes ou TEA." },
  { id: "toni4", name: "TONI-4", fullName: "Test of Nonverbal Intelligence 4", ageMin: 72, ageMax: 1068, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "Teste de inteligência não-verbal com resposta gestual; mínima dependência de linguagem ou motricidade.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "d2", name: "d2 Cancelamento", fullName: "Teste de Cancelamento d2", ageMin: 108, ageMax: 216, queixas: ["cognicao", "tdah"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "8 min", description: "Avalia atenção concentrada, velocidade de processamento e controle inibitório por tarefa de cancelamento de símbolos." },
  ...
  { id: "token-test", name: "Token Test", fullName: "Token Test Pediátrico", ageMin: 36, ageMax: 144, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10 min", description: "Avalia compreensão auditiva de ordens simples e complexas com tokens coloridos. Sensivel a afasias e atrasos de linguagem.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "eowpvt4", name: "EOWPVT-4", fullName: "Expressive One-Word Picture Vocabulary Test 4", ageMin: 24, ageMax: 216, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "Avalia vocabulário expressivo por nomeação de figuras. Complementar ao PPVT para perfil receptivo-expressivo.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "adl3", name: "ADL-3", fullName: "Auditory and Language Disorders Test 3", ageMin: 0, ageMax: 132, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "triagem", tempo: "15–20 min", description: "Triagem de distúrbios de linguagem auditiva em crianças de 0 a 11 anos.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "disc-auditiva", name: "Discriminação Auditiva", fullName: "Teste de Discriminação Auditiva", ageMin: 48, ageMax: 96, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "triagem", tempo: "10 min", description: "Avalia a capacidade da criança de diferenciar pares de sons e palavras semelhantes. Indicado na investigação de dificuldades fonológicas.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  { id: "snappe2", name: "SNAPPE-II", fullName: "Score for Neonatal Acute Physiology Perinatal Extension II", ageMin: 0, ageMax: 6, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Pontuacao de gravidade neonatal nas primeiras 12h de vida. Prediz mortalidade e morbidade em UTI neonatal.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "crib2", name: "CRIB-II", fullName: "Clinical Risk Index for Babies II", ageMin: 0, ageMax: 12, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Avalia risco clínico de recém-nascidos pré-termo nas primeiras 12 horas. Considera sexo, idade gestacional, peso e temperatura.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  ...
  // ===== TOC =====
  { id: "cybocs", name: "CY-BOCS", fullName: "Children’s Yale-Brown Obsessive Compulsive Scale", ageMin: 72, ageMax: 204, queixas: ["toc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–30 min", description: "Padrão-ouro para avaliação de gravidade de TOC em crianças e adolescentes. 10 itens em obsessões e compulsões.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "oci-cv", name: "OCI-CV", fullName: "Obsessive Compulsive Inventory — Child Version", ageMin: 84, ageMax: 204, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", description: "21 itens de triagem de sintomas obsessivo-compulsivos em crianças e adolescentes. Versão pediátrica do OCI.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  { id: "docs", name: "DOCS", fullName: "Dimensional Obsessive-Compulsive Scale", ageMin: 144, ageMax: 216, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "20 itens avaliando 4 dimensões de TOC: contaminãção, responsabilidade/dano, inaceitável/intrusivo e simetria.", verbal: true, alphabetic: true, assessment_type: "monitoring" },
  { id: "cybocs-sr", name: "CY-BOCS-SR", fullName: "Children’s Yale-Brown OCS — Self-Report", ageMin: 96, ageMax: 204, queixas: ["toc"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "Versão de autoavaliacão do CY-BOCS para monitorização de sintomas em crianças a partir de 8 anos.", verbal: true, alphabetic: true, assessment_type: "monitoring" },
  { id: "fas-pr", name: "FAS-PR", fullName: "Family Accommodation Scale for Pediatric OCD — Parent Report", ageMin: 0, ageMax: 204, queixas: ["toc"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "10 min", description: "Avalia o grau de acomodação familiar aos sintomas de TOC da criança. Importante para planejamento do tratamento.", verbal: false, alphabetic: false, assessment_type: "monitoring" },
  ...
  { id: "chq-pf50", name: "CHQ-PF50", fullName: "Child Health Questionnaire — Parent Form 50", ageMin: 60, ageMax: 216, queixas: ["funcionalidade"], respondente: ["pais"], prioridade: "monitorizacao", tempo: "10 min", description: "50 itens de qualidade de vida pediátrica respondidos pelos pais. Cobre saúde física, emocional, social e escolar.", verbal: true, alphabetic: true, assessment_type: "monitoring" },
  { id: "disabkids", name: "DISABKIDS", fullName: "DISABKIDS Chronic Generic Measure", ageMin: 96, ageMax: 192, queixas: ["funcionalidade"], respondente: ["autoaplicavel", "pais"], prioridade: "monitorizacao", tempo: "15 min", description: "Qualidade de vida genérica para crianças com condições crônicas. Avalia independência, inclusão social e emoções.", verbal: true, alphabetic: true, assessment_type: "monitoring" },
  { id: "whoqol-ped", name: "WHOQOL-BREF Pediátrico", fullName: "WHOQOL-BREF Adaptado para Adolescentes", ageMin: 144, ageMax: 216, queixas: ["funcionalidade"], respondente: ["autoaplicavel"], prioridade: "monitorizacao", tempo: "10 min", description: "26 itens da OMS de qualidade de vida em 4 domínios: físico, psicológico, social e ambiental. Adaptado para adolescentes.", verbal: true, alphabetic: true, assessment_type: "monitoring" },

  // ===== REGULAÇÃO EMOCIONAL ADICIONAL =====
  { id: "ders", name: "DERS", fullName: "Difficulties in Emotion Regulation Scale", ageMin: 144, ageMax: 216, queixas: ["ansiedade", "depressao"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "10 min", description: "36 itens avaliando múltiplas facetas da desregulação emocional: consciência, clareza, aceitacao, metas, impulso e estratégias." },  { id: "cems", name: "CEMS", fullName: "Children’s Emotion Management Scales", ageMin: 108, ageMax: 144, queixas: ["depressao"], respondente: ["autoaplicavel"], prioridade: "diagnostica", tempo: "10 min", description: "Avalia estratégias de gestão de raiva e tristeza em crianças de 9 a 12 anos: expressão, repressão e coping." },
  ...
  // ===== ENURESE =====
  { id: "dvss", name: "DVSS", fullName: "Dysfunctional Voiding Symptom Score", ageMin: 36, ageMax: 216, queixas: ["enurese"], respondente: ["pais", "autoaplicavel"], prioridade: "triagem", tempo: "5 min", description: "10 itens avaliando sintomas de disfunção miccional em crianças: urgência, freqüência, esforço, incontinencia e constipação.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "bristol-stool", name: "Bristol Stool Scale", fullName: "Bristol Stool Form Scale Adaptada Pediátrica", ageMin: 48, ageMax: 216, queixas: ["enurese"], respondente: ["pais", "autoaplicavel"], prioridade: "triagem", tempo: "2 min", description: "7 tipos de fezes ilustrados para avaliação de constipação e diarreia. Adaptada com figuras para crianças a partir de 4 anos.", verbal: false, alphabetic: false, assessment_type: "diagnostic" },
  { id: "bladder-diary", name: "Diário Vesical Pediátrico", fullName: "Bladder Diary Pediátrico", ageMin: 60, ageMax: 216, queixas: ["enurese"], respondente: ["pais", "autoaplicavel"], prioridade: "monitorizacao", tempo: "7 dias", description: "Registro diário de frequência miccional, volume, episódios de escape, ingestão hídrica e hábitos defecacionais por 7 dias.", verbal: false, alphabetic: false, assessment_type: "monitoring" },

  // ===== PSICOSE ADICIONAL =====
  { id: "sips", name: "SIPS/SOPS", fullName: "Structured Interview for Prodromal Syndromes / Scale of Prodromal Symptoms", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–60 min", description: "Entrevista estruturada para identificação de síndromes prodrômicas de psicose (UHR) em adolescentes e adultos jovens.", verbal: true, alphabetic: false, assessment_type: "diagnostic" },
  { id: "prime-screen", name: "PRIME Screen", fullName: "PRIME Screen for Psychosis Risk", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", description: "12 itens de triagem de risco ultra-alto para psicose em adolescentes. Baseado nos critérios do SIPS/SOPS.", verbal: true, alphabetic: true, assessment_type: "diagnostic" },
  ...
  // ===== TESTES DIRETOS COM A CRIANÇA (Novos 2026) =====
  { id: "funcoes-executivas", name: "Funções Executivas", fullName: "Teste Lúdico de Funções Executivas — Desempenho Direto", ageMin: 48, ageMax: 144, queixas: ["tdah", "cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", appRoute: "/funcoes-executivas", description: "Avaliação interativa de planejamento, inibição de impulso, memória de trabalho e flexibilidade cognitiva através de tarefas lúdicas observadas pelo clínico. 3–4 tarefas por faixa etária com rubric 0–2 pontos.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "atencao-concentracao", name: "Atenção e Concentração", fullName: "Teste Lúdico de Atenção e Concentração — Desempenho Direto", ageMin: 48, ageMax: 144, queixas: ["tdah", "cognicao", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–25 min", appRoute: "/atencao-concentracao", description: "Avaliação de atenção sustentada, seletiva e dividida através de tarefas visuais e auditivas interativas. Busca, discriminação visual, filtro atentivo e processamento paralelo. 4–5 itens por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "linguagem-fonologia", name: "Linguagem e Fonologia", fullName: "Teste Lúdico de Linguagem e Fonologia — Desempenho Direto", ageMin: 36, ageMax: 120, queixas: ["linguagem", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/linguagem-fonologia", description: "Avaliação de consciência fonológica, vocabulário receptivo/expressivo, compreensão narrativa e expressão linguística. Testes de rima, segmentação, sinonímia e definição. 5 tarefas por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "academico-interativo", name: "Acadêmico Interativo", fullName: "Teste de Habilidades Acadêmicas Interativas — Desempenho Direto", ageMin: 72, ageMax: 168, queixas: ["aprendizagem", "tdah"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/academico-interativo", description: "Avaliação de cálculos matemáticos, resolução de problemas com contexto e reconhecimento de sequências lógicas. Feedback imediato com explicação clínica. 3–4 domínios (cálculo, problema, sequência) por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "escrita-desenho", name: "Escrita e Desenho", fullName: "Teste de Escrita e Desenho com Canvas — Desempenho Direto", ageMin: 36, ageMax: 132, queixas: ["aprendizagem", "motor"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–25 min", appRoute: "/escrita-desenho", description: "Avaliação de habilidades de desenho interativo (canvas), cópia de figuras e escrita livre. Rubric 0–2 em critérios de proporção, controle e legibilidade. 4 tarefas (desenho, cópia, escrita) por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "conhecimento-visual", name: "Conhecimento Visual", fullName: "Teste de Discriminação e Percepção Visual — Desempenho Direto", ageMin: 48, ageMax: 132, queixas: ["cognicao", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10–15 min", appRoute: "/conhecimento-visual", description: "Avaliação de discriminação visual, figura-fundo, simetria e sequências visuais com feedback imediato. Estímulos visuais emoji-based. 3–4 itens por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "motricidade-teste", name: "Motricidade", fullName: "Teste de Motricidade Grossa e Fina — Desempenho Direto", ageMin: 24, ageMax: 108, queixas: ["motor", "cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", appRoute: "/motricidade-teste", description: "Avaliação separada de motricidade grossa (equilíbrio, locomoção, coordenação dinâmica) e fina (destreza, preensão, controle). Rubric 0–2 com critérios observáveis. 3–4 tarefas por tipo por faixa etária.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
  { id: "conhecimentos-gerais", name: "Conhecimentos Gerais", fullName: "Teste de Conhecimento Factual e Raciocínio — Desempenho Direto", ageMin: 60, ageMax: 144, queixas: ["cognicao", "aprendizagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "10–15 min", appRoute: "/conhecimentos-gerais", description: "Avaliação de conhecimento factual, raciocínio lógico e consciência cultural/geográfica. 3 domínios (factual, raciocínio, cultura) com 5–7 itens por faixa etária. Feedback clínico educativo.", fonte: "Dr. Jadson Fraga, NeuroPed — Testes Diretos Fase 2 (2026)", licencaUso: "autoral", validacaoBrasil: "Autoral — uso clínico local", pendente_validacao_clinica: false },
];
