...
export const scales: ScaleEntry[] = [
  ...
  { id: "ballard", name: "Ballard", fullName: "New Ballard Score", ageMin: 0, ageMax: 1, queixas: ["neonatal"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", description: "Avalia maturidade neuromuscular e física do recém-nascido para estimar idade gestacional ao nascimento.", appRoute: "/generic-scale/ballard"},
