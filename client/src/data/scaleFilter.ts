...
export const scales: ScaleEntry[] = [
  ...
  { id: "bears", name: "BEARS", fullName: "Bedtime, Excessive Daytime Sleepiness, Awakenings, Regularity, Snoring", ageMin: 24, ageMax: 216, queixas: ["sono"], respondente: ["pais", "autoaplicavel"], prioridade: "triagem", tempo: "5 min", description: "5 perguntas-chave para triagem de distúrbios do sono.", fonte: "Owens JA, Dalzell V, 2005", pubmedId: "PMID 15764706", validacaoBrasil: "Parcial", scoringCutoff: "triagem qualitativa sem cutoff único", licencaUso: "livre", pendente_validacao_clinica: false },
