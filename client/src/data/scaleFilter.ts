...
export const scales: ScaleEntry[] = [
  ...
  { id: "eowpvt4", name: "EOWPVT-4", fullName: "Expressive One-Word Picture Vocabulary Test 4", ageMin: 24, ageMax: 216, queixas: ["linguagem"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "Avalia vocabulário expressivo por nomeação de figuras. Complementar ao PPVT para perfil receptivo-expressivo." },
