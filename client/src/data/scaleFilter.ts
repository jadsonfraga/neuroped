...
export const scales: ScaleEntry[] = [
  ...
  { id: "prime-screen", name: "PRIME Screen", fullName: "PRIME Screen for Psychosis Risk", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10 min", description: "12 itens de triagem de risco ultra-alto para psicose em adolescentes. Baseado nos critérios do SIPS/SOPS." },
