...
export const scales: ScaleEntry[] = [
  ...
  { id: "essence-q", name: "ESSENCE-Q", fullName: "ESSENCE Questionnaire (Gillberg) — triagem precoce de neurodesenvolvimento", ageMin: 12, ageMax: 72, queixas: ["atraso", "tea", "tdah", "linguagem", "sono", "alimentacao"], respondente: ["pais", "clinico"], prioridade: "triagem", tempo: "5 min", signalTags: ["marcos do desenvolvimento", "linguagem", "atenção", "interação social", "sono", "alimentação", "regulação"], description: "12 domínios de preocupação precoce (ESSENCE: Early Symptomatic Syndromes Eliciting Neurodevelopmental Clinical Examinations). Rastreio rápido e livre para sinalizar necessidade de avaliação neurodesenvolvimental global.", fonte: "Gillberg C, 2010 — Res Dev Disabil (conceito ESSENCE); validação ESSENCE-Q: Hatakenaka Y et al., 2016", pubmedId: "PMID 20634041", validacaoBrasil: "Não publicada — uso como sinalizador clínico", scoringCutoff: "≥2 respostas 'sim/talvez' sugerem avaliação ampla", licencaUso: "livre", implementationStatus: "metadata_only", pendente_validacao_clinica: true, pendencia: "Aplicação aguarda conteúdo autoritativo dos 12 itens (tradução fiel); ficha técnica disponível." },
  ...
  { id: "brief2", name: "BRIEF-2", fullName: "Behavior Rating Inventory of Executive Function 2", ageMin: 60, ageMax: 216, queixas: ["tdah", "cognicao"], respondente: ["pais", "professor"], prioridade: "diagnostica", tempo: "10–15 min", signalTags: ["inibição", "flexibilidade", "memória de trabalho", "planejamento", "organização", "autocontrole"], appRoute: "/brief2", description: "Inibição, flexibilidade, controle emocional, memória de trabalho e planejamento.", fonte: "Gioia GA et al., 2015", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65 elevado", licencaUso: "comercial", pendente_validacao_clinica: false },
  ...
  { id: "scas", name: "SCAS", fullName: "Spence Children's Anxiety Scale", ageMin: 36, ageMax: 216, queixas: ["ansiedade"], respondente: ["autoaplicavel", "pais"], prioridade: "triagem", tempo: "10 min", description: "Avalia 6 domínios de ansiedade: separação, social, obsessões, pânico, generalizada, medo de lesão.", signalTags: ["ansiedade", "pânico", "ansiedade de separação", "fobia social", "medos específicos", "obsessões"], appRoute: "/generic-scale/scas"},
  ...
  // ===== DEPRESSÃO =====
  { id: "cdi2", name: "CDI-2", fullName: "Children's Depression Inventory 2", ageMin: 84, ageMax: 204, queixas: ["depressao"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "10–15 min", signalTags: ["humor deprimido", "anedonia", "autoestima", "ineficácia", "sintomas negativos"], appRoute: "/cdi2", description: "Inventário de Depressão Infantil — instrumento comercial (MHS). Ficha técnica no app; aplicação requer material licenciado. Alternativas livres: PHQ-A e RCADS.", fonte: "Kovacs M, 2011 - Multi-Health Systems", validacaoBrasil: "Parcial", scoringCutoff: "T-score >=65", licencaUso: "comercial", pendente_validacao_clinica: false, implementationStatus: "external_only" },
  { id: "kads6", name: "KADS-6", fullName: "Kutcher Adolescent Depression Scale — 6 itens", ageMin: 144, ageMax: 216, queixas: ["depressao"], respondente: ["autoaplicavel"], prioridade: "triagem", tempo: "3 min", signalTags: ["humor deprimido", "anedonia", "cansaço", "ideação suicida"], description: "Autorrelato breve (6 itens) para rastreio e monitorização de depressão em adolescentes. Livre para uso clínico e educacional.", fonte: "LeBlanc JC, Almudevar A, Brooks SJ, Kutcher S, 2002 — J Child Adolesc Psychopharmacol", pubmedId: "PMID 12014595", validacaoBrasil: "Não publicada — usar como triagem complementar", scoringCutoff: "≥6 sugere depressão provável (rastreio)", licencaUso: "livre", implementationStatus: "metadata_only", pendente_validacao_clinica: true, pendencia: "Aplicação aguarda conteúdo autoritativo dos 6 itens (tradução fiel); ficha técnica disponível." },
  ...
  { id: "gmfcs", name: "GMFCS", fullName: "Gross Motor Function Classification System", ageMin: 0, ageMax: 216, queixas: ["pc"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "5 min", signalTags: ["função motora grossa", "marcha", "mobilidade", "uso de cadeira", "níveis funcionais"], appRoute: "/gmfcs", description: "Classificação da função motora grossa em PC — 5 níveis.", fonte: "Palisano R et al., 2007", validacaoBrasil: "Sim", scoringCutoff: "Nível I: marcha sem restrição; II: marcha com limitações; III: requer assistência; IV: mobilidade motorizada; V: transportado", licencaUso: "livre" },
