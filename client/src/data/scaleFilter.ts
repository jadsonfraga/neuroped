...
export const scales: ScaleEntry[] = [
  ...
  // ===== PSICOSE / MANIA =====
  { id: "ymrs", name: "YMRS", fullName: "Young Mania Rating Scale", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "11 itens avaliando gravidade de mania — humor, atividade, sono, fala, pensamento." },
  ...
  { id: "panss-ped", name: "PANSS Pediátrico", fullName: "Positive and Negative Syndrome Scale — Pediátrico", ageMin: 144, ageMax: 216, queixas: ["psicose"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "30–40 min", description: "30 itens: sintomas positivos, negativos e psicopatologia geral." },
  ...
  { id: "toni4", name: "TONI-4", fullName: "Test of Nonverbal Intelligence 4", ageMin: 72, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "15–20 min", description: "Teste de inteligência não-verbal com resposta gestual; mínima dependência de linguagem ou motricidade." },
  ...
  { id: "wcst", name: "WCST", fullName: "Wisconsin Card Sorting Test", ageMin: 72, ageMax: 216, queixas: ["cognicao"], respondente: ["clinico"], prioridade: "diagnostica", tempo: "20–30 min", description: "Avalia flexibilidade cognitiva, formação de conceitos e função do lóbulo frontal por classificação de cartões." },
  ...
  // ===== TRAUMA / TEPT =====
  { id: "cpss-v", name: "CPSS-V", fullName: "Child PTSD Symptom Scale for DSM-5", ageMin: 96, ageMax: 216, queixas: ["trauma"], respondente: ["autoaplicavel", "crianca"], prioridade: "diagnostica", tempo: "15 min", description: "20 itens alinhados ao DSM-5 para diagnóstico e monitorização de TEPT em crianças e adolescentes." },
