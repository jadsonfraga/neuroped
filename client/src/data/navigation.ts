...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/satisfacao-medicacao", label: "Monitorização da medicação", icon: SmilePlus },
      { href: "/eusm10", label: "Escala Satisfação Medicação", icon: ClipboardCheck },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/testes-reconhecimento", label: "Reconhecimento", icon: BookOpen },
      { href: "/testes-academicos", label: "Testes acadêmicos", icon: School },
      { href: "/tde2", label: "TDE-2", icon: BookOpen },
