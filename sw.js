...
const CACHE_NAME = 'neuroped-edj-v6.45.4';
const SHELL = [
  './',
  './app-shell.html',
  './index.html',
  ...
  './scales-editorial.js','./scales-453-authorial.js','./scales-global-max.js','./scales-featured-extra.js','./scales-featured-10.js','./scales-priority-uploaded.js','./scales-diarios-uteis.js','./scales-autorais-npe.js','./scales-sensorial-perfil.js','./scales-impacto-medicacao.js','./neuroped-pro.html','./pro-license.js','./pro-hashes.js','./sobre-dr-jadson.html','./guia-lancamento.html','./scales-oficiais.js','./scales-oficiais-lote2.js','./scales-curate.js','./scales-red-flags.js','./scales-enhance.js','./scales-taxonomy.js','./scales-smart-rank.js','./scales-questions.js','./scales-preconsulta-gate.js','./scales-progress.js','./scales-bundle.js','./scales-question-coach.js','./scales-direct-tasks.js','./scales-index.json','./scales-clinical-signals.js',
