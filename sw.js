...
const CACHE_NAME = 'neuroped-edj-v6.45.0';
const SHELL = [
  './',
  './app-shell.html',
  './index.html',
  ...
  './retro-arcade.css','./retro-arcade.js','./app-skin.css'
];
