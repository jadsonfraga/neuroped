...
const SHELL = [
  ...
  './neuroped-shell.css','./np-cards.css','./escalas-card-premium.css','./escalas-card-premium.js','./app-polish-mobile.css','./app-polish-mobile.js','./tokens.css','./components.css','./np-frame.js','./np-embed-guard.js','./clinical-meta.js','./evidence-registry.json','./clinical-ontology.json','./master-access-policy.js','./consulta-bridge.js','./spa-route-watchdog.js',
