...
const CACHE_NAME = 'neuroped-edj-v6.4.0';
const SHELL = [
  './',
  './app-shell.html',
  './index.html',
  ...
  './scales-editorial.js','./scales-453-authorial.js','./scales-global-max.js','./scales-featured-extra.js','./scales-featured-10.js','./scales-priority-uploaded.js','./scales-diarios-uteis.js','./scales-autorais-npe.js','./scales-impacto-medicacao.js','./neuroped-pro.html','./pro-license.js','./pro-hashes.js','./scales-oficiais.js','./scales-oficiais-lote2.js','./scales-curate.js','./scales-enhance.js','./scales-index.json'
];
