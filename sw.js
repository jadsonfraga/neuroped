...
const CACHE_NAME = 'neuroped-edj-v6.44.23';
const SHELL = [
  './',
  './app-shell.html',
  './index.html',
  ...
  './clinical-explainability.js','./clinical-normalization.js','./clinical-timeline-engine.js','./phenotype-engine.js','./therapeutic-burden-engine.js','./response-engine.js','./contradiction-engine.js','./clinical-decision-support.js','./clinical-visual-schema.js','./clinical-config.example.js','./clinical-trajetoria.html','./clinical-trajetoria-demo.html',
