...
(function () {
  ...
  var css = ''
    ...
    + '.npt-card{position:fixed;z-index:100000;max-width:344px;width:calc(100vw - 36px);background:linear-gradient(180deg,#15152a,#101022);color:#eee;border:1px solid hsl(243 50% 42% / .55);border-radius:20px;box-shadow:0 24px 70px rgba(0,0,0,.55),0 0 0 1px rgba(255,255,255,.05) inset;padding:18px 18px 14px;font-family:var(--np-font-text,Inter),system-ui,sans-serif;transition:left .35s cubic-bezier(.22,.8,.2,1),top .35s cubic-bezier(.22,.8,.2,1)}'
    + '.npt-emoji{font-size:30px;line-height:1;margin-bottom:8px}'
    + '.npt-title{font:700 19px/1.2 var(--np-font-text,Inter),sans-serif;letter-spacing:-.02em;margin:0 0 6px;color:#fff}'
    ...
    + '.npt-btn{border:0;border-radius:11px;padding:9px 14px;font:700 13px var(--np-font-text,Inter),sans-serif;cursor:pointer}'
