...
function boot(){
  ...
  var items=[
    ['Anamnese por voz','Voz'],
    ['História e demanda','Anamnese'],
    ['Instrumentos','Escalas'],
    ['Receituário livre','Receituário'],
    ['Solicitação de exames','Exames'],
    ['Laudo / relatório com PDF','Laudos/PDF'],
    ['Prescrição','Prescrição'],
    ['Laudos e relatórios','Laudos'],
    ['Passe Familiar','Passe'],
