...
- 2026-05-07: Deploy para Cloudflare Pages bloqueado em ambiente não-interativo sem `CLOUDFLARE_API_TOKEN` (`wrangler pages deploy .`). Ação necessária: configurar variável de ambiente com token de Pages:Edit antes de novo deploy.
