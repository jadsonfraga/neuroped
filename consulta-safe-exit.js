(function(){
  ...
  function showReturnAfterFail(){
    ...
    bar.style.cssText='margin:0 0 16px;padding:14px;border:1px solid #fecaca;border-radius:22px;background:rgba(220,80,110,.12);box-shadow:0 12px 32px rgba(45,41,38,.09);display:flex;gap:12px;align-items:center;justify-content:space-between;flex-wrap:wrap';
    bar.innerHTML='<div style="font-weight:950;color:#ffb3c6;line-height:1.3">Senha não conferiu.<div style="font-size:12px;color:#b6b2e6;font-weight:700;margin-top:2px">Tente novamente ou volte ao conteúdo educacional.</div></div><div style="display:flex;gap:8px;flex-wrap:wrap"><button id="consultaTryPinAgain" type="button" style="border:0;background:#6d6af5;color:white;border-radius:14px;padding:12px 14px;font-weight:950;cursor:pointer">Tentar novamente</button><a href="./portal-familia-livre.html" style="text-decoration:none;background:#e7c98b;color:white;border-radius:14px;padding:12px 14px;font-weight:950">Voltar para conteúdo educacional</a></div>';
