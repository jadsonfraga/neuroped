...
--
-- O owner inicial ocupa o primeiro assento. Uma clínica em trial precisa poder
-- convidar ao menos um segundo membro para validar o fluxo multiusuário.
-- Trials existentes recebem capacidade para os membros ativos atuais + 1;
-- novas clínicas passam a nascer com 2 assentos.
